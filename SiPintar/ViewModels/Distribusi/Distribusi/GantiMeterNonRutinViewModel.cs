...
using SiPintar.Commands.Distribusi.Distribusi.GantiMeterNonRutin;
...
namespace SiPintar.ViewModels.Distribusi.Distribusi
{
    ...
    public class GantiMeterNonRutinViewModel : ViewModelBase
    {
        public readonly KelainanBacameterNonRutinViewModel KelainanBacameter;
        public readonly RotasiMeterNonRutinViewModel RotasiMeter;
        public GantiMeterNonRutinViewModel(IRestApiClientModel restApi, bool isTest = false)
        {
            KelainanBacameter = new KelainanBacameterNonRutinViewModel(this, restApi);
            RotasiMeter = new RotasiMeterNonRutinViewModel(this, restApi);
            ...
            _ = Task.Run(() =>
            {
                switch (CurrentSection)
                {
                    case "KelainanBacameter":
                        // ((KelainanBacameterNonRutinViewModel)PageViewModel).OnLoadCommand.Execute(null);
                        break;
                    case "RotasiMeter":
                        ((RotasiMeterNonRutinViewModel)PageViewModel).OnLoadCommand.Execute(null);
                        break;
                    default:
                        break;
                }
