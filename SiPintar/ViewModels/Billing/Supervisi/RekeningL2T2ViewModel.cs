...
using SiPintar.Commands.Billing.Supervisi.RekeningL2T2;
using SiPintar.Utilities;

namespace SiPintar.ViewModels.Billing.Supervisi
{
    public class RekeningL2T2ViewModel : ViewModelBase
    {
        public RekeningL2T2ViewModel(SupervisiViewModel parentViewModel, IRestApiClientModel restApi)
        {
            _ = parentViewModel;
        ...
        private ObservableCollection<RekeningLlttDto> _rekeningList = new ObservableCollection<RekeningLlttDto>();
        public ObservableCollection<RekeningLlttDto> RekeningList
        {
            get => _rekeningList;
            set { _rekeningList = value; IsEmpty = _rekeningList.Count == 0; OnPropertyChanged(); }
        }

        private RekeningLlttDto _selectedData;
        public RekeningLlttDto SelectedData
        {
            get => _selectedData;
            set
            {
        ...
        private RekeningLlttDto _rekeningFilter = new RekeningLlttDto { FlagHapus = null };
        public RekeningLlttDto RekeningFilter
        {
        ...
        private ObservableCollection<MasterTarifLlttDto> _tarifL2T2List;
        public ObservableCollection<MasterTarifLlttDto> TarifL2T2List
        {
            get { return _tarifL2T2List; }
            set
            {
                _tarifL2T2List = value;
                OnPropertyChanged();
            }
        }
        ...
        private bool _isNoL2T2Checked;
        public bool IsNoL2T2Checked
        {
            get { return _isNoL2T2Checked; }
            set
            {
                _isNoL2T2Checked = value;
                if (!value)
                {
                    var temp = RekeningFilter;
                    temp.NomorLltt = null;
        ...
        private MasterTarifLlttDto _tarifL2T2Filter;
        public MasterTarifLlttDto TarifL2T2Filter
        {
            get { return _tarifL2T2Filter; }
            set
            {
                _tarifL2T2Filter = value;
                OnPropertyChanged();

                if (RekeningFilter != null)
                    RekeningFilter.IdTarifLltt = _tarifL2T2Filter?.IdTarifLltt;
            }
        }
        ...
        public bool IsSelectAllTerbitkanPelanggan
        {
            ...
            set
            {
                ...
                var temp = new ObservableCollection<MasterPelangganLlttWpf>(TerbitkanPelangganList);
        ...
        private ObservableCollection<MasterPelangganLlttWpf> _terbitkanPelangganList;
        public ObservableCollection<MasterPelangganLlttWpf> TerbitkanPelangganList
        {
        ...
        private MasterTarifLlttDto _tarifKoreksiForm;
        public MasterTarifLlttDto TarifKoreksiForm
        {
