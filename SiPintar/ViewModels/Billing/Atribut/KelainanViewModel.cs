...
using SiPintar.Commands.Billing.Atribut.Kelainan;
using SiPintar.Utilities;

namespace SiPintar.ViewModels.Billing.Atribut
{
    public class KelainanViewModel : ViewModelBase
    {
        public KelainanViewModel(AtributViewModel parentViewModel, IRestApiClientModel restApi)
        {
            _ = parentViewModel;
