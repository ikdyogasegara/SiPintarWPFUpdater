...
using SiPintar.Commands.Billing.Atribut.Kolektif;
using SiPintar.Utilities;

namespace SiPintar.ViewModels.Billing.Atribut
{
    public class KolektifViewModel : ViewModelBase
    {
        public KolektifViewModel(AtributViewModel parentViewModel, IRestApiClientModel restApi)
        {
            _ = parentViewModel;
        ...
        {
            get => _masterKolektifList;
            set { _masterKolektifList = value; OnPropertyChanged(); }
        }

        private MasterKolektifDto _selectedData;
        public MasterKolektifDto SelectedData
        {
            get => _selectedData;
        ...
        private string _kodeKolektifForm;
        public string KodeKolektifForm
        {
            get => _kodeKolektifForm;
            set { _kodeKolektifForm = value; OnPropertyChanged(); }
        }

        private string _namaKolektifForm;
        public string NamaKolektifForm
        {
            get => _namaKolektifForm;
            set { _namaKolektifForm = value; OnPropertyChanged(); }
        }

        private string _keteranganForm;
        public string KeteranganForm
        {
            get => _keteranganForm;
            set { _keteranganForm = value; OnPropertyChanged(); }
        }
