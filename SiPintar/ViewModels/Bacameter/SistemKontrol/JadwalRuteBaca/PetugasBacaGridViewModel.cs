...
using SiPintar.Commands.Bacameter.SistemKontrol.JadwalRuteBaca.PetugasBacaGrid;
using SiPintar.Utilities;

namespace SiPintar.ViewModels.Bacameter.SistemKontrol.JadwalRuteBaca
{
    public class PetugasBacaGridViewModel : ViewModelBase
    {
        public PetugasBacaGridViewModel(JadwalRuteBacaViewModel parent, IRestApiClientModel restApi)
        {
            Parent = parent;
        ...
        private ObservableCollection<SummaryPetugasBacaDto> _dataList { get; set; }
        public ObservableCollection<SummaryPetugasBacaDto> DataList
        {
        ...
        private SummaryPetugasBacaDto _selectedData { get; set; }
        public SummaryPetugasBacaDto SelectedData
        {
