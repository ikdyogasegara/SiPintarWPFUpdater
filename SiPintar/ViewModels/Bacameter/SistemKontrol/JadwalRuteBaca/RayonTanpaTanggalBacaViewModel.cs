...
using SiPintar.Commands.Bacameter.SistemKontrol.JadwalRuteBaca.RayonTanpaTanggalBaca;
using SiPintar.Utilities;

namespace SiPintar.ViewModels.Bacameter.SistemKontrol.JadwalRuteBaca
{
    public class RayonTanpaTanggalBacaViewModel : ViewModelBase
    {
        public RayonTanpaTanggalBacaViewModel(JadwalRuteBacaViewModel parent, IRestApiClientModel restApi)
        {
            Parent = parent;
        ...
        private ObservableCollection<SummaryRayonTanpaTanggalBacaDto> _dataList { get; set; }
        public ObservableCollection<SummaryRayonTanpaTanggalBacaDto> DataList
        {
        ...
        private SummaryRayonTanpaTanggalBacaDto _selectedData { get; set; }
        public SummaryRayonTanpaTanggalBacaDto SelectedData
        {
