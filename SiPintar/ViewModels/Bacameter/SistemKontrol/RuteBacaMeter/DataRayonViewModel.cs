...
using SiPintar.Commands.Bacameter.SistemKontrol.RuteBacaMeter.DataRayon;
using SiPintar.Utilities;

namespace SiPintar.ViewModels.Bacameter.SistemKontrol.RuteBacaMeter
{
    public class DataRayonViewModel : ViewModelBase
    {
        public DataRayonViewModel(RuteBacaMeterViewModel parent, IRestApiClientModel restApi)
        {
            _parent = parent;
