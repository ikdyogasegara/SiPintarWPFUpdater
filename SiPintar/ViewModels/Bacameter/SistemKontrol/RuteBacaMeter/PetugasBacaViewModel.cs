...
using SiPintar.Commands.Bacameter.SistemKontrol.RuteBacaMeter.PetugasBaca;
...
namespace SiPintar.ViewModels.Bacameter.SistemKontrol.RuteBacaMeter
{
    ...
    {
        public PetugasBacaViewModel(RuteBacaMeterViewModel parent, IRestApiClientModel restApi)
        {
            _parent = parent;
