...
using SiPintar.Commands.Bacameter.SistemKontrol.TarifGolongan.Golongan;
...
namespace SiPintar.ViewModels.Bacameter.SistemKontrol.TarifGolongan
{
    ...
    {
        public GolonganViewModel(TarifGolonganViewModel parentViewModel, IRestApiClientModel restApi)
        {
            _ = parentViewModel;
