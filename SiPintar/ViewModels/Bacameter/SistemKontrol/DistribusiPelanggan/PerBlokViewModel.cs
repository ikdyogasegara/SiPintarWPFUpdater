...
using SiPintar.Commands.Bacameter.SistemKontrol.DistribusiPelanggan.PerBlok;
using SiPintar.Utilities;

namespace SiPintar.ViewModels.Bacameter.SistemKontrol.DistribusiPelanggan
{
    public class PerBlokViewModel : ViewModelBase
    {
        public PerBlokViewModel(DistribusiPelangganViewModel parent, IRestApiClientModel restApi)
        {
            Parent = parent;
        ...
        private ObservableCollection<SummaryDistribusiPelangganDto> _blok { get; set; }
        public ObservableCollection<SummaryDistribusiPelangganDto> BlokList
        {
            get { return _blok; }
            set
            {
        ...
        public void LoadSeries()
        {
            ...
            Labels = BlokList.Select(x => x.Nama).ToArray();

            JumlahDistribusiPelangganSeries = BlokList.Select(x => (int)x.Jumlah).AsChartValues();
