...
using SiPintar.Commands.Bacameter.SistemKontrol.DistribusiPelanggan.PerRayon;
...
namespace SiPintar.ViewModels.Bacameter.SistemKontrol.DistribusiPelanggan
{
    ...
    {
        public PerRayonViewModel(DistribusiPelangganViewModel parent, IRestApiClientModel restApi)
        {
            Parent = parent;
        ...
        private ObservableCollection<SummaryDistribusiPelangganDto> _rayon { get; set; }
        public ObservableCollection<SummaryDistribusiPelangganDto> RayonList
        {
            get { return _rayon; }
            set
            {
        ...
        public void LoadSeries()
        {
            ...
            Labels = RayonList.Select(x => x.Nama).ToArray();

            JumlahDistribusiPelangganSeries = RayonList.Select(x => (int)x.Jumlah).AsChartValues();

            foreach (var item in RayonList)
            {
