...
using SiPintar.Commands.Bacameter.SistemKontrol.DistribusiPelanggan.PerKelurahan;
using SiPintar.Utilities;

namespace SiPintar.ViewModels.Bacameter.SistemKontrol.DistribusiPelanggan
{
    public class PerKelurahanViewModel : ViewModelBase
    {
        public PerKelurahanViewModel(DistribusiPelangganViewModel parent, IRestApiClientModel restApi)
        {
            Parent = parent;
        ...
        private ObservableCollection<SummaryDistribusiPelangganDto> _kelurahan { get; set; }
        public ObservableCollection<SummaryDistribusiPelangganDto> KelurahanList
        {
        ...
        public void LoadSeries()
        {
            ...
            Labels = KelurahanList.Select(x => x.Nama).ToArray();

            JumlahDistribusiPelangganSeries = KelurahanList.Select(x => (int)x.Jumlah).AsChartValues();

            foreach (var item in KelurahanList)
            {
