...
using SiPintar.Commands.Bacameter.SistemKontrol.DistribusiPelanggan.PerKecamatan;
using SiPintar.Utilities;

namespace SiPintar.ViewModels.Bacameter.SistemKontrol.DistribusiPelanggan
{
    public class PerKecamatanViewModel : ViewModelBase
    {
        public PerKecamatanViewModel(DistribusiPelangganViewModel parent, IRestApiClientModel restApi)
        {
            Parent = parent;
        ...
        private ObservableCollection<SummaryDistribusiPelangganDto> _kecamatan { get; set; }
        public ObservableCollection<SummaryDistribusiPelangganDto> KecamatanList
        {
        ...
        public void LoadSeries()
        {
            ...
            Labels = KecamatanList.Select(x => x.Nama).ToArray();

            JumlahDistribusiPelangganSeries = KecamatanList.Select(x => (int)x.Jumlah).AsChartValues();

            foreach (var item in KecamatanList)
            {
