...
using SiPintar.Commands.Bacameter.SistemKontrol.DistribusiPelanggan.PerGolongan;
using SiPintar.Utilities;

namespace SiPintar.ViewModels.Bacameter.SistemKontrol.DistribusiPelanggan
{
    public class PerGolonganViewModel : ViewModelBase
    {
        public PerGolonganViewModel(DistribusiPelangganViewModel parent, IRestApiClientModel restApi)
        {
            Parent = parent;
        ...
        private ObservableCollection<SummaryDistribusiPelangganDto> _golongan { get; set; }
        public ObservableCollection<SummaryDistribusiPelangganDto> GolonganList
        {
        ...
        public void LoadSeries()
        {
            ...
            Labels = GolonganList.Select(x => x.Nama).ToArray();

            JumlahDistribusiPelangganSeries = GolonganList.Select(x => (int)x.Jumlah).AsChartValues();

            foreach (var item in GolonganList)
            {
