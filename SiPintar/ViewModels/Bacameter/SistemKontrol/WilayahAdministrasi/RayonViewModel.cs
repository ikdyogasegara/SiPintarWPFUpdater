...
using SiPintar.Commands.Bacameter.SistemKontrol.WilayahAdministrasi.Rayon;
using SiPintar.Utilities;

namespace SiPintar.ViewModels.Bacameter.SistemKontrol.WilayahAdministrasi
{
    public class RayonViewModel : ViewModelBase
    {
        public RayonViewModel(WilayahAdministrasiViewModel parentViewModel, IRestApiClientModel _restApi)
        {
            _ = parentViewModel;
