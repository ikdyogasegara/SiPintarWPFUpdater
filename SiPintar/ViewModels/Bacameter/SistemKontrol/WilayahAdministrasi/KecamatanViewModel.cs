...
using SiPintar.Commands.Bacameter.SistemKontrol.WilayahAdministrasi.Kecamatan;
using SiPintar.Utilities;

namespace SiPintar.ViewModels.Bacameter.SistemKontrol.WilayahAdministrasi
{
    public class KecamatanViewModel : ViewModelBase
    {
        public KecamatanViewModel(WilayahAdministrasiViewModel parentViewModel, IRestApiClientModel _restApi)
        {
            _ = parentViewModel;
