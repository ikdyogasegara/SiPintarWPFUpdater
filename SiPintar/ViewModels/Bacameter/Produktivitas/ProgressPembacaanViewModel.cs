...
using SiPintar.Commands.Bacameter.Produktivitas.ProgressPembacaan;
using SiPintar.Utilities;

namespace SiPintar.ViewModels.Bacameter.Produktivitas
{
    [ExcludeFromCodeCoverage]
    public class ProgressPembacaanViewModel : ViewModelBase
    {
        public ProgressPembacaanViewModel(ProduktivitasViewModel parent, IRestApiClientModel restApi)
        {
            Parent = parent;
        ...
        private ObservableCollection<SummaryProduktifitasBacameterProgressPembacaanDto> _dataList { get; set; }
        public ObservableCollection<SummaryProduktifitasBacameterProgressPembacaanDto> DataList
        {
        ...
        private SummaryProduktifitasBacameterProgressPembacaanDto _selectedData { get; set; }
        public SummaryProduktifitasBacameterProgressPembacaanDto SelectedData
        {
