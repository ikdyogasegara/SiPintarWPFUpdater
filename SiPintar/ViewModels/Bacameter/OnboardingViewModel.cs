...
using SiPintar.Commands.Bacameter.Onboarding;

namespace SiPintar.ViewModels.Bacameter
{
    public class OnboardingViewModel : ViewModelBase
    {
        public OnboardingViewModel(BacameterViewModel parentViewModel, bool isTest = false)
        {
            ...
            ClosePageCommand = new OnClosePageCommand(this, isTest);
