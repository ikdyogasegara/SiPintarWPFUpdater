...
using SiPintar.Commands.Hublang.Atribut.Pekerjaan;
using SiPintar.Utilities;

namespace SiPintar.ViewModels.Hublang.Atribut
{
    public class PekerjaanViewModel : ViewModelBase
    {
        public PekerjaanViewModel(IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        private MasterPekerjaanDto _selectedData;
        public MasterPekerjaanDto SelectedData
        {
        ...
        private MasterPekerjaanDto _formData;
        public MasterPekerjaanDto FormData
        {
        ...
        private bool _isNamaPekerjaanChecked;
        public bool IsNamaPekerjaanChecked
        {
            get { return _isNamaPekerjaanChecked; }
            set
            {
                _isNamaPekerjaanChecked = value;
                if (!value)
                {
                    FilterNamaPekerjaan = null;
                }
                OnPropertyChanged();
            }
        }

        private string _filterNamaPekerjaan;
        public string FilterNamaPekerjaan
        {
            get { return _filterNamaPekerjaan; }
            set
            {
                _filterNamaPekerjaan = value;
                OnPropertyChanged();
            }
        }
