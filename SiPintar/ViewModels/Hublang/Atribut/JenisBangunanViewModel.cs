...
using SiPintar.Commands.Hublang.Atribut.JenisBangunan;
using SiPintar.Utilities;

namespace SiPintar.ViewModels.Hublang.Atribut
{
    public class JenisBangunanViewModel : ViewModelBase
    {
        public JenisBangunanViewModel(IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        private MasterJenisBangunanDto _selectedData;
        public MasterJenisBangunanDto SelectedData
        {
        ...
        private MasterJenisBangunanDto _formData;
        public MasterJenisBangunanDto FormData
        {
        ...
        private bool _isNamaJenisBangunanChecked;
        public bool IsNamaJenisBangunanChecked
        {
            get { return _isNamaJenisBangunanChecked; }
            set
            {
                _isNamaJenisBangunanChecked = value;
                if (!value)
                {
                    FilterNamaJenisBangunan = null;
                }
                OnPropertyChanged();
            }
        }

        private string _filterNamaJenisBangunan;
        public string FilterNamaJenisBangunan
        {
            get { return _filterNamaJenisBangunan; }
            set
            {
                _filterNamaJenisBangunan = value;
                OnPropertyChanged();
            }
        }
