...
using SiPintar.Commands.Akuntansi.Navigator;
...
{
    public class AkuntansiViewModel : ViewModelBase
    {
        private readonly INavigator _navigator;
        public OnboardingViewModel _onboardingViewModel;

        public ViewModelBase CurrentViewModel => _navigator?.AkuntansiCurrentViewModel;
        ...
        public AkuntansiViewModel(INavigator navigator, IViewModelFactory viewModelFactory, IRestApiClientModel restApi, MainViewModel parent)
        {
        ...
        {
            var isOnboardBefore = Application.Current.Resources["OnBoardAkuntansiFlag"].ToString();
