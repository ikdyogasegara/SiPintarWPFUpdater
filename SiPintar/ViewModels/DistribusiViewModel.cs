...
using SiPintar.Commands.Distribusi.Navigator;
...
namespace SiPintar.ViewModels
{
    public class DistribusiViewModel : ViewModelBase
    {
        ...
        public ViewModelBase CurrentViewModel => _navigator?.DistribusiCurrentViewModel;
        ...
        public DistribusiViewModel(INavigator navigator, IViewModelFactory viewModelFactory, IRestApiClientModel restApi, MainViewModel parent)
        {
        ...
        {
            var isOnboardBefore = Application.Current.Resources["OnBoardDistribusiFlag"].ToString();
