...
using SiPintar.Commands.Loket.Angsuran.AngsuranNonAir;
using SiPintar.Utilities;

namespace SiPintar.ViewModels.Loket.Angsuran
{
    public class AngsuranNonAirViewModel : VmBase
    {
        public AngsuranNonAirViewModel(AngsuranViewModel parent, IRestApiClientModel restApi, bool isTest = false)
        {
            Parent = parent;
        ...
        public bool IsDetailAngsuranVisible
        {
            ...
            set
            {
                ...
                Parent.ParentCurrentSection = "NonAirLainnya";
