...
using SiPintar.Commands.Personalia.GajiPokok.DewanPengawas;
using SiPintar.Utilities;

namespace SiPintar.ViewModels.Personalia.GajiPokok
{
    public class DewanPengawasViewModel : ViewModelBase
    {
        public DewanPengawasViewModel(IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        private ObservableCollection<MasterPegawaiGajiDewanPengawasDto> _dewanPengawasList;
        public ObservableCollection<MasterPegawaiGajiDewanPengawasDto> DewanPengawasList
        {
            get { return _dewanPengawasList; }
            set { _dewanPengawasList = value; OnPropertyChanged(); }
        }

        private MasterPegawaiGajiDewanPengawasDto _selectedData;
        public MasterPegawaiGajiDewanPengawasDto SelectedData
        {
        ...
        private string _formJabatan2;
        public string FormJabatan2
        {
            get { return _formJabatan2; }
            set { _formJabatan2 = value; OnPropertyChanged(); }
        }
