...
using SiPintar.Commands.Personalia.GajiPokok.PegawaiTetap;
using SiPintar.Utilities;

namespace SiPintar.ViewModels.Personalia.GajiPokok
{
    public class PegawaiTetapViewModel : ViewModelBase
    {
        public PegawaiTetapViewModel(IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        private ObservableCollection<MasterPegawaiGajiTetapDto> _pegawaiTetapList;
        public ObservableCollection<MasterPegawaiGajiTetapDto> PegawaiTetapList
        {
            get { return _pegawaiTetapList; }
            set { _pegawaiTetapList = value; OnPropertyChanged(); }
        }
