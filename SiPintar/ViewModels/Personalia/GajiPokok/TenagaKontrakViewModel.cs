...
using SiPintar.Commands.Personalia.GajiPokok.TenagaKontrak;
using SiPintar.Utilities;

namespace SiPintar.ViewModels.Personalia.GajiPokok
{
    public class TenagaKontrakViewModel : ViewModelBase
    {
        public TenagaKontrakViewModel(IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        private ObservableCollection<MasterPegawaiGajiKontrakDto> _tenagaKontrakList;
        public ObservableCollection<MasterPegawaiGajiKontrakDto> TenagaKontrakList
        {
            get { return _tenagaKontrakList; }
            set { _tenagaKontrakList = value; OnPropertyChanged(); }
        }

        private MasterPegawaiGajiKontrakDto _selectedData;
        public MasterPegawaiGajiKontrakDto SelectedData
        {
