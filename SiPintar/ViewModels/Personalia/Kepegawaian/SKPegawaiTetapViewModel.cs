...
using SiPintar.Commands.Personalia.Kepegawaian.SKPegawaiTetap;
using SiPintar.Utilities;

namespace SiPintar.ViewModels.Personalia.Kepegawaian
{
    public class SKPegawaiTetapViewModel : ViewModelBase
    {
        public SKPegawaiTetapViewModel(IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        private ObservableCollection<MutasiStatusTetapDto> _skPegawaiTetapList;
        public ObservableCollection<MutasiStatusTetapDto> SKPegawaiTetapList
        {
            get { return _skPegawaiTetapList; }
            set { _skPegawaiTetapList = value; OnPropertyChanged(); }
        }

        private MutasiStatusTetapDto _selectedData;
        public MutasiStatusTetapDto SelectedData
        {
            get { return _selectedData; }
            set { _selectedData = value; OnPropertyChanged(); }
        }

        private MutasiStatusTetapDetailDto _selectedDetailData;
        public MutasiStatusTetapDetailDto SelectedDetailData
        {
            get { return _selectedDetailData; }
            set { _selectedDetailData = value; OnPropertyChanged(); }
        }

        private ObservableCollection<PegawaiTetapWpf> _pegawaiList;
        public ObservableCollection<PegawaiTetapWpf> PegawaiList
        {
        ...
        private ObservableCollection<MutasiStatusTetapDetailDto> _formDetailList;
        public ObservableCollection<MutasiStatusTetapDetailDto> FormDetailList
        {
            get { return _formDetailList; }
            set { _formDetailList = value; OnPropertyChanged(); }
        }

        private MutasiStatusTetapDetailDto _formDetailData;
        public MutasiStatusTetapDetailDto FormDetailData
        {
    ...
    public class PegawaiTetapWpf : MasterPegawaiDto
    {
