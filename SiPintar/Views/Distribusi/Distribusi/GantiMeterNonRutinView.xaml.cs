...
{
    /// <summary>
    /// Interaction logic for GantiMeterNonRutinView.xaml
    /// </summary>
    public partial class GantiMeterNonRutinView : UserControl
    {
        private GantiMeterNonRutinViewModel CurrentViewModel;

        public GantiMeterNonRutinView()
        {
            InitializeComponent();
            Focusable = true;
        ...
        {
            CurrentViewModel = (GantiMeterNonRutinViewModel)DataContext;
