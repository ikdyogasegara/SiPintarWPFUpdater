...
namespace SiPintar.Views.Hublang.Pelayanan.Permohonan
{
    public partial class MapView : UserControl
    {
        ...
        private void MainMap_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            if (!_isMapInitiated)
            {
                var _viewModel = (PermohonanViewModel)DataContext;
            ...
            if (_viewModel.IsFor == "detail" || _viewModel.FiturName == "SPK")
            {
                MainMap.Height = 500;
        ...
        private async Task SearchAddressAsync(PermohonanViewModel _viewModel)
        {
