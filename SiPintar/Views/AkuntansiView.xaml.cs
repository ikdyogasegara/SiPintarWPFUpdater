...
{
    /// <summary>
    /// Interaction logic for AkuntansiView.xaml
    /// </summary>
    public partial class AkuntansiView : Window
    {
        public AkuntansiView(object dataContext)
        {
        ...
        {
            var dC = DataContext as AkuntansiViewModel;
        ...
        {
            ((AkuntansiViewModel)DataContext).OnAddToBgProcessCommand.Execute(data);
        }
