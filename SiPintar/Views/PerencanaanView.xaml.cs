...
{
    /// <summary>
    /// Interaction logic for PerencanaanView.xaml
    /// </summary>
    public partial class PerencanaanView : Window
    {
        public PerencanaanView(object dataContext)
        {
        ...
        {
            var dC = DataContext as PerencanaanViewModel;
        ...
        {
            ((PerencanaanViewModel)DataContext).OnBackToMainMenuCommand.Execute("perencanaan");
        }

        public void AddToBgProcess(BackgroundProcessHelper.ProcessObject data)
        {
            ((PerencanaanViewModel)DataContext).OnAddToBgProcessCommand.Execute(data);
        }
