...
{
    /// <summary>
    /// Interaction logic for GudangView.xaml
    /// </summary>
    public partial class GudangView : Window
    {
        public GudangView(object dataContext)
        {
        ...
        {
            var dC = DataContext as GudangViewModel;
        ...
        {
            ((GudangViewModel)DataContext).OnAddToBgProcessCommand.Execute(data);
        }
