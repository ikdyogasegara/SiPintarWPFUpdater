...
{
    /// <summary>
    /// Interaction logic for InteraksiLayananView.xaml
    /// </summary>
    public partial class InteraksiLayananView : UserControl
    {
        public InteraksiLayananView()
        {
            InitializeComponent();
        ...
        {
            var Vm = DataContext as InteraksiLayananViewModel;
        ...
        {
            if (DataContext is InteraksiLayananViewModel vm)
            {
                vm.CurrentPage--;
