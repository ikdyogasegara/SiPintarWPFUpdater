...
{
    /// <summary>
    /// Interaction logic for InteraksiJenisPersediaanView.xaml
    /// </summary>
    public partial class InteraksiJenisPersediaanView : UserControl
    {
        public InteraksiJenisPersediaanView()
        {
            InitializeComponent();
        ...
        {
            if (DataContext is InteraksiJenisPersediaanViewModel vm)
            {
                vm.CurrentPage--;
