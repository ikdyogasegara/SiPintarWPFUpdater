...
{
    /// <summary>
    /// Interaction logic for BacameterView.xaml
    /// </summary>
    public partial class BacameterView : Window
    {
        public BacameterView(object dataContext)
        {
        ...
        {
            var dC = DataContext as BacameterViewModel;
        ...
        {
            ((BacameterViewModel)DataContext).OnAddToBgProcessCommand.Execute(data);
        }
