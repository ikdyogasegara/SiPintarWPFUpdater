...
{
    public partial class KondisiMeterView : UserControl
    {
        public KondisiMeterView()
        {
            InitializeComponent();
        }
        ...
        {
            var _viewModel = (KondisiMeterViewModel)DataGridKondisiMeter.DataContext;
            var FileType = ((MenuItem)sender).Tag.ToString();

            var param = new Dictionary<string, dynamic>()
            {
                { "Data", DataGridKondisiMeter },
                { "FileType", FileType }
            };
