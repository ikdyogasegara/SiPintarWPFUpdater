...
namespace SiPintar.Views.Billing.Atribut.WilayahAdministrasi.Dma
{
    public partial class DialogFormView : UserControl
    {
        ...
        public DialogFormView(object dataContext)
        {
            ...
            _viewModel = (DmaViewModel)DataContext;

            Title.Text = _viewModel.IsEdit ? "Koreksi " : "Tambah ";
            Title.Text += "District Meter Area";
        ...
        {
            string notifikasi = _viewModel.DmaList.FirstOrDefault(i => i.KodeDma == Kode.Text) != null ? notif.Text = "Kode telah digunakan" : notif.Text = "";
        ...
        {
            string notifikasi = _viewModel.DmaList.FirstOrDefault(i => i.NamaDma == Nama.Text) != null ? notif.Text = "Nama telah digunakan" : notif.Text = "";
