...
{
    public partial class KepemilikanView : UserControl
    {
        public KepemilikanView()
        {
            InitializeComponent();
        }
        ...
        {
            var _viewModel = (KepemilikanViewModel)DataGridKepemilikan.DataContext;
            var FileType = ((MenuItem)sender).Tag.ToString();

            var param = new Dictionary<string, dynamic>()
            {
                { "Data", DataGridKepemilikan },
                { "FileType", FileType }
            };
