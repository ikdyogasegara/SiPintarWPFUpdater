...
{
    public partial class AdministrasiLainView : UserControl
    {
        public AdministrasiLainView()
        {
            InitializeComponent();
        }
        ...
        {
            var _viewModel = (AdministrasiLainViewModel)DataGridAdministrasi.DataContext;
            var FileType = ((MenuItem)sender).Tag.ToString();

            var param = new Dictionary<string, dynamic>()
            {
                { "Data", DataGridAdministrasi },
                { "FileType", FileType }
            };
