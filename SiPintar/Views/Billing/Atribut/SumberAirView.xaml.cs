...
{
    public partial class SumberAirView : UserControl
    {
        public SumberAirView()
        {
            InitializeComponent();
        }
        ...
        {
            var viewModel = (SumberAirViewModel)DataGridSumberAir.DataContext;
            var fileType = ((MenuItem)sender).Tag.ToString();

            var param = new Dictionary<string, dynamic>()
            {
                { "Data", DataGridSumberAir },
                { "FileType", fileType }
            };
