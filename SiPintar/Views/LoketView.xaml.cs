...
{
    /// <summary>
    /// Interaction logic for LoketView.xaml
    /// </summary>
    public partial class LoketView : Window
    {
        public LoketView(object dataContext)
        {
            MaxHeight = SystemParameters.MaximizedPrimaryScreenHeight;
            InitializeComponent();
            DataContext = dataContext;
            RootWindow.Margin = new Thickness(8);
        ...
        {
            RootWindow.Margin = WindowState == WindowState.Maximized ? new Thickness(8) : new Thickness(0);
        }

        public void OnPrepare()
        {
            var dC = DataContext as LoketViewModel;
        ...
        {
            ((LoketViewModel)DataContext).OnAddToBgProcessCommand.Execute(data);
        }
