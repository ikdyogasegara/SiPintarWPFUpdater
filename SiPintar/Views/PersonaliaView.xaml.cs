...
{
    /// <summary>
    /// Interaction logic for PersonaliaView.xaml
    /// </summary>
    public partial class PersonaliaView : Window
    {
        public PersonaliaView(object dataContext)
        {
        ...
        {
            var dC = DataContext as PersonaliaViewModel;
        ...
        {
            ((PersonaliaViewModel)DataContext).OnAddToBgProcessCommand.Execute(data);
        }
