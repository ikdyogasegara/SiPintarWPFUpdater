...
{
    /// <summary>
    /// Interaction logic for JenisBarangView.xaml
    /// </summary>
    public partial class JenisBarangView : UserControl
    {
        public JenisBarangView()
        {
            InitializeComponent();
        }
        ...
        {
            var Vm = DataContext as JenisBarangViewModel;
            if (Vm != null)
            {
