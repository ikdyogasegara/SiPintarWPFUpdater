...
{
    /// <summary>
    /// Interaction logic for KategoriBarangKeluarView.xaml
    /// </summary>
    public partial class KategoriBarangKeluarView : UserControl
    {
        public KategoriBarangKeluarView()
        {
            InitializeComponent();
        }
        ...
        {
            var Vm = DataContext as KategoriBarangKeluarViewModel;
            if (Vm != null)
            {
