...
{
    /// <summary>
    /// Interaction logic for BagianMemintaBarangView.xaml
    /// </summary>
    public partial class BagianMemintaBarangView : UserControl
    {
        public BagianMemintaBarangView()
        {
            InitializeComponent();
        }
        ...
        {
            var Vm = DataContext as BagianMemintaBarangViewModel;
            if (Vm != null)
            {
