...
{
    public partial class SettingTableTunggakanView : UserControl
    {
        private readonly AngsuranTunggakanViewModel _viewModel;
        public SettingTableTunggakanView(object dataContext)
        {
            InitializeComponent();
            DataContext = dataContext;
            _viewModel = (AngsuranTunggakanViewModel)DataContext;
