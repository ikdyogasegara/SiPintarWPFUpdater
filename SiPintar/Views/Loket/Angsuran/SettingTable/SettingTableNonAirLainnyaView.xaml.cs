...
{
    public partial class SettingTableNonAirLainnyaView : UserControl
    {
        private readonly AngsuranNonAirViewModel _viewModel;
        public SettingTableNonAirLainnyaView(object dataContext)
        {
            InitializeComponent();
            DataContext = dataContext;
            _viewModel = (AngsuranNonAirViewModel)DataContext;
