...
{
    public partial class TunggakanView : UserControl
    {
        public TunggakanView()
        {
            InitializeComponent();
        }
        ...
        {
            if (!(DataContext is AngsuranTunggakanViewModel vm))
            {
                return;
            }
            ...
            ((OnCetakCommand)vm.OnCetakSpaCommand).TemplateName = "SuratPernyataanAngsuranAir";
        ...
        private void DesginTemplateBeritaAcara_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            ((OnCetakCommand)vm.OnCetakBeritaAcaraCommand).TemplateName = "BeritaAcaraAngsuranAir";
