...
{
    /// <summary>
    /// Interaction logic for HublangView.xaml
    /// </summary>
    public partial class HublangView : Window
    {
        public HublangView(object dataContext)
        {
        ...
        {
            var dC = DataContext as HublangViewModel;
            Onboard.DataContext = dC.OnboardingViewModel;
        }
        ...
        {
            ((HublangViewModel)DataContext).OnAddToBgProcessCommand.Execute(data);
        }
