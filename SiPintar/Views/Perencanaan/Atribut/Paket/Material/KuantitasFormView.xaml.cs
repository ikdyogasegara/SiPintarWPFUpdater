    ...
    public partial class KuantitasFormView : UserControl
    {
        ...
        private void Submit_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (_viewModel.IsEdit)
                _ = Task.Run(() => ((AsyncCommandBase)_viewModel.OnSubmitEditBarangCommand).ExecuteAsync(null));
            else
                _ = Task.Run(() => ((AsyncCommandBase)_viewModel.OnSubmitAddBarangStep2Command).ExecuteAsync(null));
        }
