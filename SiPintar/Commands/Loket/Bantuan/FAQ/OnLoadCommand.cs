...
using static SiPintar.ViewModels.Loket.Bantuan.FaqViewModel;

namespace SiPintar.Commands.Loket.Bantuan.FAQ
{
    [ExcludeFromCodeCoverage]
    public class OnLoadCommand : AsyncCommandBase
    {
        private readonly FaqViewModel _viewModel;
        private readonly string DirectoryToScan = $"{Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location)}\\FAQ\\Loket";
