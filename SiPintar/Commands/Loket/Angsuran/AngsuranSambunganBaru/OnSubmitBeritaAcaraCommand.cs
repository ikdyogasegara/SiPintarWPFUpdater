...
namespace SiPintar.Commands.Loket.Angsuran.AngsuranSambunganBaru
{
    public class OnSubmitBeritaAcaraCommand : AsyncCommandBase
    {
        ...
        public OnSubmitBeritaAcaraCommand(AngsuranSambunganBaruViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.PatchAsync($"/api/{_restApi.GetApiVersion()}/rekening-angsuran-non-air-set-berita-acara", null, param));
