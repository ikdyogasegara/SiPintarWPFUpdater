...
namespace SiPintar.Commands.Loket.Angsuran.AngsuranSambunganBaru
{
    public class OnOpenPublishAngsuranCommand : AsyncCommandBase
    {
        ...
        public OnOpenPublishAngsuranCommand(AngsuranSambunganBaruViewModel viewModel, bool isTest = false)
        {
            ...
            if (_viewModel.SelectedData?.NoAngsuran != null)
            {
                ...
                else
                {
                    await DialogHelper.ShowDialogGlobalYesCancelViewAsync(
                        ...
                        $"Publish angsuran sambungan baru atas nama {_viewModel.SelectedData.Nama} sekarang ?",
                        "success",
