...
{
    public class OnSubmitAddNonAirLainnyaCommand : AsyncCommandBase
    {
        private readonly AngsuranViewModel _viewModel;
        private readonly IRestApiClientModel _restApi;
        private readonly bool _isTest;

        public OnSubmitAddNonAirLainnyaCommand(AngsuranViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            _viewModel.FormSubmitAngsuranNonAir = new ParamRekeningAngsuranNonAirDto()
            {
                ...
                NoAngsuran = "0",
                IdPelangganAir = _viewModel.SelectedRekeningNonAir.IdPelangganAir,
                IdPelangganLimbah = _viewModel.SelectedRekeningNonAir.IdPelangganLimbah,
                IdPelangganLltt = _viewModel.SelectedRekeningNonAir.IdPelangganLltt,
            ...
            await ((AsyncCommandBase)_viewModel._nonair.OnLoadCommand).ExecuteAsync(null);
