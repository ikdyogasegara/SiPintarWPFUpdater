...
namespace SiPintar.Commands.Loket.Angsuran.AngsuranNonAir
{
    public class OnOpenPublishAngsuranCommand : AsyncCommandBase
    {
        ...
        public OnOpenPublishAngsuranCommand(AngsuranNonAirViewModel viewModel, bool isTest = false)
        {
            ...
            if (_viewModel.SelectedData?.NoAngsuran != null)
            {
                ...
                else
                {
                    await DialogHelper.ShowDialogGlobalYesCancelViewAsync(
                        ...
                        $"Publish angsuran non air lainnya atas nama {_viewModel.SelectedData.Nama} sekarang ?",
                        "success",
