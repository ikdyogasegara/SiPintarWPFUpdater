...
namespace SiPintar.Commands.Loket.Angsuran.AngsuranNonAir
{
    ...
    public class OnSubmitSettingTableCommand : AsyncCommandBase
    {
        ...
        public OnSubmitSettingTableCommand(AngsuranNonAirViewModel viewModel, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            try
            {
                ...
                data["non_air_lainnya"]["nama"] = CheckValue(param, "Nama");
                data["non_air_lainnya"]["jenis_angsuran"] = CheckValue(param, "JenisAngsuran");
                data["non_air_lainnya"]["no_angsuran"] = CheckValue(param, "NoAngsuran");
                data["non_air_lainnya"]["termin"] = CheckValue(param, "Termin");
                data["non_air_lainnya"]["jumlah"] = CheckValue(param, "Jumlah");
                data["non_air_lainnya"]["alamat"] = CheckValue(param, "Alamat");
                data["non_air_lainnya"]["waktu_daftar"] = CheckValue(param, "WaktuDaftar");
                data["non_air_lainnya"]["dibebankan_kepada"] = CheckValue(param, "DibebankanKepada");
                data["non_air_lainnya"]["no_samb"] = CheckValue(param, "NoSamb");
                data["non_air_lainnya"]["no_berita_acara"] = CheckValue(param, "NomorBA");
