...
{
    public class OnOpenAddTunggakanCommand : AsyncCommandBase
    {
        private readonly AngsuranViewModel _viewModel;
        private readonly bool _isTest;

        public OnOpenAddTunggakanCommand(AngsuranViewModel viewModel, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            _viewModel.JenisAngsuran = "Tunggakan";
        ...
        private void ShowDialog()
        {
            if (!_isTest)
            {
                _ = DialogHost.Show(new FormTunggakanView(_viewModel), "LoketRootDialog");
