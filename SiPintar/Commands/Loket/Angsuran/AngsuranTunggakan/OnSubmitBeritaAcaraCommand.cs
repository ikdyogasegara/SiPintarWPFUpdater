...
namespace SiPintar.Commands.Loket.Angsuran.AngsuranTunggakan
{
    public class OnSubmitBeritaAcaraCommand : AsyncCommandBase
    {
        ...
        public OnSubmitBeritaAcaraCommand(AngsuranTunggakanViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.PatchAsync($"/api/{_restApi.GetApiVersion()}/rekening-angsuran-air-set-berita-acara", null, param));
