...
namespace SiPintar.Commands.Loket.Angsuran.AngsuranTunggakan
{
    public class OnSubmitPublishAngsuranCommand : AsyncCommandBase
    {
        ...
        public OnSubmitPublishAngsuranCommand(AngsuranTunggakanViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.PatchAsync($"/api/{_restApi.GetApiVersion()}/rekening-angsuran-air-publish", null, param));
