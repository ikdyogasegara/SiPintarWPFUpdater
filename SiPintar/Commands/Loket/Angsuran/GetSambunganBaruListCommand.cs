...
{
    public class GetSambunganBaruListCommand : AsyncCommandBase
    {
        ...
        public GetSambunganBaruListCommand(AngsuranViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.GetAsync($"/api/{ApiVersion}/rekening-non-air", param));
