...
{
    public class OnOpenAddSambunganBaruCommand : AsyncCommandBase
    {
        private readonly AngsuranViewModel _viewModel;
        private readonly bool _isTest;

        public OnOpenAddSambunganBaruCommand(AngsuranViewModel viewModel, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            _viewModel.JenisAngsuran = "SambunganBaru";
        ...
        private void ShowDialog()
        {
            if (!_isTest)
            {
                _ = DialogHost.Show(new FormSambunganBaruView(_viewModel), "LoketRootDialog");
                _ = ((AsyncCommandBase)_viewModel.GetSambunganBaruListCommand).ExecuteAsync(null);
            }
        }
    }
}
