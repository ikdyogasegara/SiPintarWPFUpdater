...
namespace SiPintar.Commands.Gudang.MasterData.BagianMemintaBarang
{
    public class OnSubmitEditFormCommand : AsyncCommandBase
    {
        ...
        public OnSubmitEditFormCommand(BagianMemintaBarangViewModel _vm, IRestApiClientModel _restApi, bool _isTest = false)
        {
            Vm = _vm;
            RestApi = _restApi;
            IsTest = _isTest;
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            Param.Add("idBagianMemintaBarang", _param.IdBagianMemintaBarang);
            ...
            var Response = await Task.Run(() => RestApi.PatchAsync($"/api/{ApiVersion}/master-bagian-meminta-barang", null, Param));
