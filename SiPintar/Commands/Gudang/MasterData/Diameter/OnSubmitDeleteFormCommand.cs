...
namespace SiPintar.Commands.Gudang.MasterData.Diameter
{
    public class OnSubmitDeleteFormCommand : AsyncCommandBase
    {
        ...
        public OnSubmitDeleteFormCommand(DiameterViewModel _vm, IRestApiClientModel _restApi, bool _isTest = false)
        {
            Vm = _vm;
            RestApi = _restApi;
            IsTest = _isTest;
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            Param.Add("idDiameterBarang", Vm.SelectedData.IdDiameterBarang);
            var Response = await Task.Run(() => RestApi.DeleteAsync($"/api/{ApiVersion}/master-diameter-barang", Param));
