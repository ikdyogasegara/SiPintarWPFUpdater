...
namespace SiPintar.Commands.Gudang.ProsesTransaksi.DaftarBarangMasuk
{
    public class OnOpenTambahBarangCommand : AsyncCommandBase
    {
        ...
        public OnOpenTambahBarangCommand(DaftarBarangMasukViewModel vm, bool isTest = false)
        {
            _vm = vm;
            _isTest = isTest;
        }
        ...
        private object GetDialog() => new DialogKoreksiTambahBarang(_vm, isEdit: false);
    }
}
