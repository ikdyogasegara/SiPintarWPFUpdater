...
{
    public class OnBukaPeriodePostingCommand : AsyncCommandBase
    {
        ...
        public OnBukaPeriodePostingCommand(PeriodePostingViewModel _vm, IRestApiClientModel _restApi, bool _isTest = false)
        {
            Vm = _vm;
            RestApi = _restApi;
            IsTest = _isTest;
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            object dg = await DialogHelper.ShowDialogGlobalLoadingAsync(
                ...
                header: "Mohon tunggu",
                message1: "sedang membuka periode..."
            );
