...
{
    public class OnUnVerifikasiSemuaBarangCommand : AsyncCommandBase
    {
        private readonly DaftarBarangKeluarViewModel _vm;
        private readonly IRestApiClientModel _restApi;
        private readonly bool _isTest;

        public OnUnVerifikasiSemuaBarangCommand(DaftarBarangKeluarViewModel vm, IRestApiClientModel restApi, bool isTest = false)
        {
            _vm = vm;
            _restApi = restApi;
            _isTest = isTest;
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            if (_vm.SelectedDaftarBarangKeluar != null && _vm.SelectedDaftarBarangKeluar.IdBarangKeluar != null)
            {
                ...
                var resDetail = await _restApi.PatchAsync($"/api/{_restApi.GetApiVersion()}/barang-keluar-unverifikasi", string.Empty, param);
                DialogHelper.CloseDialog(_isTest, true, "GudangRootDialog");
