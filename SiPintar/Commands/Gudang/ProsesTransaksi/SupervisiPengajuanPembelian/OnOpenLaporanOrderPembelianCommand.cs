...
{
    public class OnOpenLaporanOrderPembelianCommand : AsyncCommandBase
    {
        ...
        public OnOpenLaporanOrderPembelianCommand(SupervisiPengajuanPembelianViewModel _vm, IRestApiClientModel _restApi, bool _isTest = false)
        {
            Vm = _vm;
            RestApi = _restApi;
            IsTest = _isTest;
        ...
        private object GetInstance() => new DialogLaporanOrderPembelianView(Vm);
    }
}
