...
namespace SiPintar.Commands.Billing.Supervisi.RekeningLimbah
{
    public class OnSubmitTerbitkanPelangganCommand : AsyncCommandBase
    {
        ...
        public OnSubmitTerbitkanPelangganCommand(RekeningLimbahViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.PatchAsync($"/api/{ApiVersion}/rekening-limbah-terbitkan-pelanggan", null, body));
            if (!Response.IsError)
            {
