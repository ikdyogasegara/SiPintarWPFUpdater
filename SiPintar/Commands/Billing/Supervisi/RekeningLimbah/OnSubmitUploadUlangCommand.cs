...
namespace SiPintar.Commands.Billing.Supervisi.RekeningLimbah
{
    public class OnSubmitUploadUlangCommand : AsyncCommandBase
    {
        ...
        public OnSubmitUploadUlangCommand(RekeningLimbahViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.PostAsync($"/api/{ApiVersion}/upload-tagihan-limbah-per-rekening", body));
            if (!Response.IsError)
            {
