...
{
    public class OnSubmitHapusRekeningCommand : AsyncCommandBase
    {
        ...
        public OnSubmitHapusRekeningCommand(RekeningLimbahViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.DeleteAsync($"/api/{ApiVersion}/rekening-limbah-hapus", entityId));
            if (!Response.IsError)
            {
