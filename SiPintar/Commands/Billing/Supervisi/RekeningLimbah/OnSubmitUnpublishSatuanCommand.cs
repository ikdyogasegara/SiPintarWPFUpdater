...
namespace SiPintar.Commands.Billing.Supervisi.RekeningLimbah
{
    public class OnSubmitUnpublishSatuanCommand : AsyncCommandBase
    {
        ...
        public OnSubmitUnpublishSatuanCommand(RekeningLimbahViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.PatchAsync($"/api/{ApiVersion}/rekening-limbah-unpublish", null, body));
            if (!Response.IsError)
            {
