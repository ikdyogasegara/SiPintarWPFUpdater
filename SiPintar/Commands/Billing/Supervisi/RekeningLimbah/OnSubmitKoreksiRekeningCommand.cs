...
{
    public class OnSubmitKoreksiRekeningCommand : AsyncCommandBase
    {
        ...
        public OnSubmitKoreksiRekeningCommand(RekeningLimbahViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var body = new Dictionary<string, dynamic>
            {
                ...
                { "IdPelangganLimbah", (int)_viewModel.SelectedData.IdPelangganLimbah },
                { "Biaya", _viewModel.BiayaKoreksiForm }
            };

            var Response = await Task.Run(() => _restApi.PatchAsync($"/api/{ApiVersion}/rekening-limbah-update", null, body));
            if (!Response.IsError)
            {
