...
namespace SiPintar.Commands.Billing.Supervisi.PelangganLimbah
{
    public class OnSubmitEditCommand : AsyncCommandBase
    {
        ...
        public OnSubmitEditCommand(PelangganLimbahViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            {
                { "IdPelangganLimbah", param["IdPelangganLimbah"] },
            ...
            var Response = await Task.Run(() => _restApi.PatchAsync($"/api/{ApiVersion}/master-pelanggan-limbah", null, body));
            if (!Response.IsError)
            {
