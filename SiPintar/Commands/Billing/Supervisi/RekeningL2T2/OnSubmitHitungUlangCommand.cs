...
namespace SiPintar.Commands.Billing.Supervisi.RekeningL2T2
{
    public class OnSubmitHitungUlangCommand : AsyncCommandBase
    {
        ...
        public OnSubmitHitungUlangCommand(RekeningL2T2ViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.PatchAsync($"/api/{ApiVersion}/rekening-lltt-hitung-ulang", null, body));
            if (!Response.IsError)
            {
