...
namespace SiPintar.Commands.Billing.Supervisi.RekeningL2T2
{
    public class OnSubmitHapusRekeningCommand : AsyncCommandBase
    {
        ...
        public OnSubmitHapusRekeningCommand(RekeningL2T2ViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.DeleteAsync($"/api/{ApiVersion}/rekening-lltt-hapus", entityId));
            if (!Response.IsError)
            {
