...
{
    public class OnSubmitUploadUlangCommand : AsyncCommandBase
    {
        ...
        public OnSubmitUploadUlangCommand(RekeningL2T2ViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.PostAsync($"/api/{ApiVersion}/upload-tagihan-lltt-per-rekening", body));
            if (!Response.IsError)
            {
