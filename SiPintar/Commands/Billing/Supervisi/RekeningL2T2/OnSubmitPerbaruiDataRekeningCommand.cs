...
namespace SiPintar.Commands.Billing.Supervisi.RekeningL2T2
{
    public class OnSubmitPerbaruiDataRekeningCommand : AsyncCommandBase
    {
        ...
        public OnSubmitPerbaruiDataRekeningCommand(RekeningL2T2ViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var ListIdPelanggan = new int[] { (int)_viewModel.SelectedData.IdPelangganLltt };

            var body = new Dictionary<string, dynamic>
            {
                { "IdPeriode", _viewModel.PeriodePerbaruiForm.IdPeriode },
                { "IdPelangganLltt", ListIdPelanggan }
            };
