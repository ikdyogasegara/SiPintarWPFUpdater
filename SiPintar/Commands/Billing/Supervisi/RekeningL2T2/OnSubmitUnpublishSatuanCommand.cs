...
{
    public class OnSubmitUnpublishSatuanCommand : AsyncCommandBase
    {
        ...
        public OnSubmitUnpublishSatuanCommand(RekeningL2T2ViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var PelangganList = new int[] { (int)_viewModel.SelectedData.IdPelangganLltt };
            ...
            var Response = await Task.Run(() => _restApi.PatchAsync($"/api/{ApiVersion}/rekening-lltt-unpublish", null, body));
            if (!Response.IsError)
            {
