...
{
    public class OnSubmitPublishSatuanCommand : AsyncCommandBase
    {
        ...
        public OnSubmitPublishSatuanCommand(RekeningL2T2ViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
