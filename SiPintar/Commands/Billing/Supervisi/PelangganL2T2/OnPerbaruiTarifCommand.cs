...
{
    public class OnPerbaruiTarifCommand : AsyncCommandBase
    {
        ...
        public OnPerbaruiTarifCommand(PelangganL2T2ViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.PatchAsync($"/api/{ApiVersion}/master-pelanggan-air-perbarui-tarif-lltt", null, null));
            if (!Response.IsError)
            {
        ...
        {
            _ = DialogHost.Show(new GlobalLoadingDialog(null, "Semua Tarif Pelanggan", "sedang diperbarui"), "BillingRootDialog");
        }
