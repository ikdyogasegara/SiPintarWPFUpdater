...
namespace SiPintar.Commands.Billing.Supervisi.PelangganL2T2
{
    public class OnSubmitDeleteCommand : AsyncCommandBase
    {
        ...
        public OnSubmitDeleteCommand(PelangganL2T2ViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.DeleteAsync($"/api/{ApiVersion}/master-pelanggan-lltt", entityId));
            if (!Response.IsError)
            {
