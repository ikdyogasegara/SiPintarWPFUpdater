...
namespace SiPintar.Commands.Billing.Supervisi.PelangganL2T2
{
    public class OnSubmitAddCommand : AsyncCommandBase
    {
        ...
        public OnSubmitAddCommand(PelangganL2T2ViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.PostAsync($"/api/{ApiVersion}/master-pelanggan-lltt", body));
            if (!Response.IsError)
            {
