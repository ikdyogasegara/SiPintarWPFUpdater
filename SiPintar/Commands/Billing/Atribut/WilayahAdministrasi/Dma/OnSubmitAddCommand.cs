...
namespace SiPintar.Commands.Billing.Atribut.WilayahAdministrasi.Dma
{
    public class OnSubmitAddCommand : AsyncCommandBase
    {
        ...
        public OnSubmitAddCommand(DmaViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.PostAsync($"/api/{ApiVersion}/master-dma", body));
            if (!Response.IsError)
            {
