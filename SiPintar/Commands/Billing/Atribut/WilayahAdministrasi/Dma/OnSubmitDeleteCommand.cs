...
namespace SiPintar.Commands.Billing.Atribut.WilayahAdministrasi.Dma
{
    public class OnSubmitDeleteCommand : AsyncCommandBase
    {
        ...
        public OnSubmitDeleteCommand(DmaViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.DeleteAsync($"/api/{ApiVersion}/master-dma", entityId));
            if (!Response.IsError)
            {
