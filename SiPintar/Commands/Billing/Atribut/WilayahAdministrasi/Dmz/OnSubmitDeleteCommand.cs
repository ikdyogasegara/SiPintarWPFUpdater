...
namespace SiPintar.Commands.Billing.Atribut.WilayahAdministrasi.Dmz
{
    public class OnSubmitDeleteCommand : AsyncCommandBase
    {
        ...
        public OnSubmitDeleteCommand(DmzViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.DeleteAsync($"/api/{ApiVersion}/master-dmz", entityId));
            if (!Response.IsError)
            {
