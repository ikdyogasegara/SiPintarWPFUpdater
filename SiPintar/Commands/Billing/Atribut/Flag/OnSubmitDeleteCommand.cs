...
namespace SiPintar.Commands.Billing.Atribut.Flag
{
    public class OnSubmitDeleteCommand : AsyncCommandBase
    {
        ...
        public OnSubmitDeleteCommand(FlagViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.DeleteAsync($"/api/{ApiVersion}/master-flag", entityId));
            if (!Response.IsError)
            {
