...
namespace SiPintar.Commands.Billing.Atribut.Tarif.AdministrasiLain
{
    public class OnSubmitAddCommand : AsyncCommandBase
    {
        ...
        public OnSubmitAddCommand(AdministrasiLainViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.PostAsync($"/api/{ApiVersion}/master-tarif-administrasi-lain", body));
            if (!Response.IsError)
            {
