...
namespace SiPintar.Commands.Billing.Atribut.Tarif.AdministrasiLain
{
    public class OnSubmitDeleteCommand : AsyncCommandBase
    {
        ...
        public OnSubmitDeleteCommand(AdministrasiLainViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.DeleteAsync($"/api/{ApiVersion}/master-tarif-administrasi-lain", entityId));
            if (!Response.IsError)
            {
