...
namespace SiPintar.Commands.Billing.Atribut.Tarif.GolonganLLTT
{
    public class OnSubmitEditCommand : AsyncCommandBase
    {
        ...
        public OnSubmitEditCommand(GolonganLlttViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.PatchAsync($"/api/{ApiVersion}/master-tarif-lltt", null, body));
            if (!Response.IsError)
            {
