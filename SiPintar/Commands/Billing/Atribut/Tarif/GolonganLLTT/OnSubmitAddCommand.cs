...
namespace SiPintar.Commands.Billing.Atribut.Tarif.GolonganLLTT
{
    public class OnSubmitAddCommand : AsyncCommandBase
    {
        ...
        public OnSubmitAddCommand(GolonganLlttViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            _viewModel.GolonganFormLltt.PeriodeMulaiBerlaku = (_viewModel.Year * 100) + _viewModel.Month;

            Type type = typeof(MasterTarifLlttDto);
            ...
            foreach (PropertyInfo property in properties)
            {
                ...
                {
                    body.Add(property.Name, property.GetValue(_viewModel.GolonganFormLltt));
                }
            }

            var Response = await Task.Run(() => _restApi.PostAsync($"/api/{ApiVersion}/master-tarif-lltt", body));
            if (!Response.IsError)
            {
