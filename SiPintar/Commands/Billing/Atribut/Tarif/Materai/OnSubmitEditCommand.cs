...
namespace SiPintar.Commands.Billing.Atribut.Tarif.Materai
{
    public class OnSubmitEditCommand : AsyncCommandBase
    {
        ...
        public OnSubmitEditCommand(MateraiViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            _viewModel.MateraiForm.KodePeriodeMulaiBerlaku = (_viewModel.Year * 100) + _viewModel.Month;

            Type type = typeof(MasterMeteraiDto);
            ...
            foreach (PropertyInfo property in properties)
            {
                ...
                {
                    body.Add(property.Name, property.GetValue(_viewModel.MateraiForm));
                }
            }

            var Response = await Task.Run(() => _restApi.PatchAsync($"/api/{ApiVersion}/master-meterai", null, body));
            if (!Response.IsError)
            {
