...
namespace SiPintar.Commands.Billing.Atribut.Tarif.Golongan
{
    public class OnSubmitAddCommand : AsyncCommandBase
    {
        ...
        public OnSubmitAddCommand(GolonganViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            _viewModel.GolonganForm.PeriodeMulaiBerlaku = (_viewModel.Year * 100) + _viewModel.Month;
            ...
            var Response = await Task.Run(() => _restApi.PostAsync($"/api/{ApiVersion}/master-tarif-golongan", body));
            if (!Response.IsError)
            {
