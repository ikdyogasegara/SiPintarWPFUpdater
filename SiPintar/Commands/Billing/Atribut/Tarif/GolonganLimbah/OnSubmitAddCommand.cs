...
namespace SiPintar.Commands.Billing.Atribut.Tarif.GolonganLimbah
{
    public class OnSubmitAddCommand : AsyncCommandBase
    {
        ...
        public OnSubmitAddCommand(GolonganLimbahViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            _viewModel.GolonganFormLimbah.PeriodeMulaiBerlaku = (_viewModel.Year * 100) + _viewModel.Month;

            Type type = typeof(MasterTarifLimbahDto);
            ...
            foreach (PropertyInfo property in properties)
            {
                ...
                {
                    body.Add(property.Name, property.GetValue(_viewModel.GolonganFormLimbah));
                }
            }

            var Response = await Task.Run(() => _restApi.PostAsync($"/api/{ApiVersion}/master-tarif-limbah", body));
            if (!Response.IsError)
            {
