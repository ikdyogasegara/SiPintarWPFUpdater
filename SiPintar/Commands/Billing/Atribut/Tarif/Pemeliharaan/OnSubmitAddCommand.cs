...
namespace SiPintar.Commands.Billing.Atribut.Tarif.Pemeliharaan
{
    public class OnSubmitAddCommand : AsyncCommandBase
    {
        ...
        public OnSubmitAddCommand(PemeliharaanViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.PostAsync($"/api/{ApiVersion}/master-tarif-pemeliharaan-lain", body));
            if (!Response.IsError)
            {
