...
namespace SiPintar.Commands.Billing.Atribut.Tarif.Retribusi
{
    public class OnSubmitEditCommand : AsyncCommandBase
    {
        ...
        public OnSubmitEditCommand(RetribusiViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            {
                { "IdRetribusiLain", _viewModel.SelectedData.IdRetribusiLain },
                //{ "KodeRetribusiLain", _viewModel.RetribusiForm.KodeRetribusiLain },
                //{ "NamaRetribusiLain", _viewModel.RetribusiForm.NamaRetribusiLain },
                //{ "Retribusi", _viewModel.RetribusiForm.Retribusi },
                { "KodeRetribusiLain", _viewModel.KodeRetribusiForm },
                { "NamaRetribusiLain", _viewModel.NamaRetribusiForm },
                { "Retribusi", _viewModel.BiayaRetribusiForm },
            };

            var Response = await Task.Run(() => _restApi.PatchAsync($"/api/{ApiVersion}/master-tarif-retribusi-lain", null, body));
            if (!Response.IsError)
            {
