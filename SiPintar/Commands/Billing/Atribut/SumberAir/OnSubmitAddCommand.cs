...
namespace SiPintar.Commands.Billing.Atribut.SumberAir
{
    public class OnSubmitAddCommand : AsyncCommandBase
    {
        ...
        public OnSubmitAddCommand(SumberAirViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.PostAsync($"/api/{ApiVersion}/master-sumber-air", body));
            if (!Response.IsError)
            {
