...
namespace SiPintar.Commands.Billing.Atribut.Loket.LoketTerdaftar
{
    public class OnSubmitEditCommand : AsyncCommandBase
    {
        ...
        public OnSubmitEditCommand(LoketTerdaftarViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.PatchAsync($"/api/{ApiVersion}/master-loket", null, body));
            if (!Response.IsError)
            {
