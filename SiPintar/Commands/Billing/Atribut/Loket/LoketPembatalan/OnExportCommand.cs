...
namespace SiPintar.Commands.Billing.Atribut.Loket.LoketPembatalan
{
    ...
    public class OnExportCommand : AsyncCommandBase
    {
        ...
        public OnExportCommand(LoketPembatalanViewModel viewModel)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            string FileName = "Master Pembatalan Transaksi Loket";
            string TitlePage = "Data Master Pembatalan Transaksi Loket";
        ...
        {
            var Item = Data.ItemsSource as IList<MasterAlasanBatalDto>;
            var json = JsonConvert.SerializeObject(Item);
            var data = (DataTable)JsonConvert.DeserializeObject(json, typeof(DataTable));

            string[] ColumnsToBeDeleted = { "IdPdam", "IdAlasanBatal", "FlagHapus", "IdUserRequest" };
