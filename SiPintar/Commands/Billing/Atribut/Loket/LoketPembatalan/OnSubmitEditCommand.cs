...
namespace SiPintar.Commands.Billing.Atribut.Loket.LoketPembatalan
{
    public class OnSubmitEditCommand : AsyncCommandBase
    {
        ...
        public OnSubmitEditCommand(LoketPembatalanViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.PatchAsync($"/api/{ApiVersion}/master-alasan-batal", null, body));
            if (!Response.IsError)
            {
