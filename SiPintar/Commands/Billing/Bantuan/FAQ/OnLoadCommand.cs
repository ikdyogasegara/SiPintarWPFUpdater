...
using static SiPintar.ViewModels.Billing.Bantuan.FaqViewModel;

namespace SiPintar.Commands.Billing.Bantuan.FAQ
{
    [ExcludeFromCodeCoverage]
    public class OnLoadCommand : AsyncCommandBase
    {
        private readonly FaqViewModel _viewModel;
        private readonly string DirectoryToScan = $"{Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location)}\\FAQ\\Billing";
