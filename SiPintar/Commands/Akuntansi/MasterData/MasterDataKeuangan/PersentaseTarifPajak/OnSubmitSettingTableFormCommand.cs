...
namespace SiPintar.Commands.Akuntansi.MasterData.MasterDataKeuangan.PersentaseTarifPajak
{
    public class OnSubmitSettingTableFormCommand : AsyncCommandBase
    {
        ...
        public OnSubmitSettingTableFormCommand(PersentaseTarifPajakViewModel viewModel, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            try
            {
                ...
                data["show_table_column"]["KodePersen"] = CheckValue(param, "KodePersen");
                data["show_table_column"]["NamaPersen"] = CheckValue(param, "NamaPersen");
                data["show_table_column"]["JumlahPersen"] = CheckValue(param, "JumlahPersen");
