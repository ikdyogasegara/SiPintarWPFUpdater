...
namespace SiPintar.Commands.Akuntansi.Jurnal.Instalasi.DaftarHutang
{
    public class OnOpenConfirmProsesJurnalCommand : AsyncCommandBase
    {
        ...
        public OnOpenConfirmProsesJurnalCommand(DaftarHutangViewModel viewModel, IRestApiClientModel restApi, bool isTest = false, bool isTrue = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            else
            {
                ...
                false,
                "AkuntansiRootDialog",
                $"Proses Ulang Posting Data DHHD?",
                $"Data DHHD untuk bulan April 2021 sudah tersedia,\nApakah Anda ingin melakukan proses ulang?",
                "confirmation",
