...
namespace SiPintar.Commands.Akuntansi.Jurnal.Rekening.RekAir
{
    public class OnProsesJurnalCommand : AsyncCommandBase, System.IDisposable
    {
        ...
        public OnProsesJurnalCommand(RekAirViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            if (!_isTest) Application.Current.Dispatcher.Invoke(delegate { CloseDialog(); });
