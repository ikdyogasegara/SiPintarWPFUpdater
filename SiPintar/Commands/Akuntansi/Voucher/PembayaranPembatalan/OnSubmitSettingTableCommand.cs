...
namespace SiPintar.Commands.Akuntansi.Voucher.PembayaranPembatalan
{
    public class OnSubmitSettingTableCommand : AsyncCommandBase
    {
        ...
        public OnSubmitSettingTableCommand(PembayaranPembatalanViewModel viewModel, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            try
            {
                var configIni = $"{Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location)}\\AppConfig\\Akuntansi\\voucher_pembayaranpembatalan_config.ini";
                ...
                data["show_table_column"]["sisa_bayar"] = CheckValue(param, "SisaBayar");
