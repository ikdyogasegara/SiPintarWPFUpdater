...
{
    public class OnOpenPembatalanFormCommand : AsyncCommandBase
    {
        private readonly PembayaranPembatalanViewModel _viewModel;
        private readonly IRestApiClientModel _restApi;
        private readonly bool _isTest;

        public OnOpenPembatalanFormCommand(PembayaranPembatalanViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        private object GetInstance() => new DialogPembatalanFormView(_viewModel);
    }
}
