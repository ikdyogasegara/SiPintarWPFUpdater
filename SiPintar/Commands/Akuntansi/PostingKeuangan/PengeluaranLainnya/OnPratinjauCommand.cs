...
namespace SiPintar.Commands.Akuntansi.PostingKeuangan.PengeluaranLainnya
{
    public class OnPratinjauCommand : AsyncCommandBase
    {
        ...
        public OnPratinjauCommand(PengeluaranLainnyaViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        private async Task PratinjauProcessAsync()
        {
            ...
            ((OnCetakCommand)_viewModel.OnCetakCommand).TemplateName = "DaftarPengeluaranLainnya";
