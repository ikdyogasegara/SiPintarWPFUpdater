...
{
    public class OnSubmitConfirmProsesPiutangCommand : AsyncCommandBase
    {
        private readonly ProsesPiutangBulananViewModel _viewModel;
        private readonly bool _isTest;
        private readonly IRestApiClientModel _restApi;

        public OnSubmitConfirmProsesPiutangCommand(ProsesPiutangBulananViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
