...
namespace SiPintar.Commands.Personalia.DataMaster.Divisi
{
    public class OnOpenEditFormCommand : AsyncCommandBase
    {
        ...
        public OnOpenEditFormCommand(DivisiViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            if (_viewModel.SelectedData != null)
            {
                ...
                _viewModel.FormDivisi = _viewModel.SelectedData.Divisi;
                _viewModel.FormDivisiAtas = _viewModel.SelectedData.IdDivisiAtas;
