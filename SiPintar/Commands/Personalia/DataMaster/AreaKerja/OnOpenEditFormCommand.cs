...
namespace SiPintar.Commands.Personalia.DataMaster.AreaKerja
{
    public class OnOpenEditFormCommand : AsyncCommandBase
    {
        ...
        public OnOpenEditFormCommand(AreaKerjaViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            {
                _viewModel.FormKodeAreaKerja = _viewModel.SelectedData.KodeAreaKerja;
                _viewModel.FormAreaKerja = _viewModel.SelectedData.AreaKerja;
