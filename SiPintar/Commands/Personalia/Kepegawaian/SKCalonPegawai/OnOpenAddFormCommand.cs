...
namespace SiPintar.Commands.Personalia.Kepegawaian.SKCalonPegawai
{
    public class OnOpenAddFormCommand : AsyncCommandBase
    {
        ...
        public OnOpenAddFormCommand(SKCalonPegawaiViewModel viewModel, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            _viewModel.FormDetailList = new ObservableCollection<MutasiStatusCapegDetailDto>();
