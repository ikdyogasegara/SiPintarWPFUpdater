...
namespace SiPintar.Commands.Personalia.Kepegawaian.SKCalonPegawai
{
    public class OnUploadFotoCommand : AsyncCommandBase
    {
        ...
        public OnUploadFotoCommand(SKCalonPegawaiViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.UploadAsync($"/api/{_restApi.GetApiVersion()}/mutasi-status-capeg-upload-foto", body));
