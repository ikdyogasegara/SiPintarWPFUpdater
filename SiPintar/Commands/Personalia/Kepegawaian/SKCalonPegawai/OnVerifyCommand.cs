...
namespace SiPintar.Commands.Personalia.Kepegawaian.SKCalonPegawai
{
    public class OnVerifyCommand : AsyncCommandBase
    {
        ...
        public OnVerifyCommand(SKCalonPegawaiViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            if (_viewModel.SelectedData != null)
            {
                ...
                RestApiResponse Response = await Task.Run(() => _restApi.PatchAsync($"/api/{_restApi.GetApiVersion()}/mutasi-status-capeg-verifikasi", null, body));
