...
namespace SiPintar.Commands.Personalia.Kepegawaian.MutasiJabatan
{
    public class OnVerifyCommand : AsyncCommandBase
    {
        ...
        public OnVerifyCommand(MutasiJabatanViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            if (_viewModel.SelectedData != null)
            {
                ...
                RestApiResponse Response = await Task.Run(() => _restApi.PatchAsync($"/api/{_restApi.GetApiVersion()}/mutasi-jabatan-verifikasi", null, body));
