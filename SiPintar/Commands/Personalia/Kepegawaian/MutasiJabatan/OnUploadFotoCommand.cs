...
namespace SiPintar.Commands.Personalia.Kepegawaian.MutasiJabatan
{
    public class OnUploadFotoCommand : AsyncCommandBase
    {
        ...
        public OnUploadFotoCommand(MutasiJabatanViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.UploadAsync($"/api/{_restApi.GetApiVersion()}/mutasi-jabatan-upload-foto", body));
