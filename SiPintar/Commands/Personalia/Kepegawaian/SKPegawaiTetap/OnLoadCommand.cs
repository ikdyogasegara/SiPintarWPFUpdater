...
namespace SiPintar.Commands.Personalia.Kepegawaian.SKPegawaiTetap
{
    public class OnLoadCommand : AsyncCommandBase
    {
        ...
        public OnLoadCommand(SKPegawaiTetapViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.GetAsync($"/api/{_restApi.GetApiVersion()}/mutasi-status-pegawai-tetap", param));
            _viewModel.SKPegawaiTetapList = new ObservableCollection<MutasiStatusTetapDto>();
            if (!Response.IsError)
            {
                var Result = Response.Data;
                if (Result.Status && Result.Data != null)
                {
                    _viewModel.SKPegawaiTetapList = Result.Data.ToObject<ObservableCollection<MutasiStatusTetapDto>>();
                }
                else
            ...
            _viewModel.IsEmpty = !_viewModel.SKPegawaiTetapList.Any();
