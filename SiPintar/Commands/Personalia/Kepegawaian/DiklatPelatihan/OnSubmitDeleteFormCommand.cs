...
namespace SiPintar.Commands.Personalia.Kepegawaian.DiklatPelatihan
{
    public class OnSubmitDeleteFormCommand : AsyncCommandBase
    {
        ...
        public OnSubmitDeleteFormCommand(DiklatPelatihanViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var body = new Dictionary<string, dynamic> { { "IdDiklat", _viewModel.SelectedDataTable.IdDiklat } };

            RestApiResponse Response = await Task.Run(() => _restApi.DeleteAsync($"/api/{_restApi.GetApiVersion()}/diklat", body));
