...
namespace SiPintar.Commands.Personalia.GajiPokok.DewanPengawas
{
    public class OnOpenEditFormCommand : AsyncCommandBase
    {
        ...
        public OnOpenEditFormCommand(DewanPengawasViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            if (_viewModel.SelectedData != null)
            {
                ...
                _viewModel.FormJabatan2 = _viewModel.SelectedData.KeteranganJabatan;
