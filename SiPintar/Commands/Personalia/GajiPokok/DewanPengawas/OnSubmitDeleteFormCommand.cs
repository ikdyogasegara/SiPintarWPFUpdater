...
namespace SiPintar.Commands.Personalia.GajiPokok.DewanPengawas
{
    public class OnSubmitDeleteFormCommand : AsyncCommandBase
    {
        ...
        public OnSubmitDeleteFormCommand(DewanPengawasViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var body = new Dictionary<string, dynamic> { { "IdGajiDewanPengawas", _viewModel.SelectedData.IdGajiDewanPengawas } };

            RestApiResponse Response = await Task.Run(() => _restApi.DeleteAsync($"/api/{_restApi.GetApiVersion()}/master-gaji-pegawai-dewan-pengawas", body));
