...
namespace SiPintar.Commands.Personalia.GajiPokok.TenagaKontrak
{
    public class OnSubmitDeleteFormCommand : AsyncCommandBase
    {
        ...
        public OnSubmitDeleteFormCommand(TenagaKontrakViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var body = new Dictionary<string, dynamic> { { "IdGajiKontrak", _viewModel.SelectedData.IdGajiKontrak } };

            RestApiResponse Response = await Task.Run(() => _restApi.DeleteAsync($"/api/{_restApi.GetApiVersion()}/master-gaji-pegawai-kontrak", body));
