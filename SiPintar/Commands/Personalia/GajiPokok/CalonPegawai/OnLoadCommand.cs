...
namespace SiPintar.Commands.Personalia.GajiPokok.CalonPegawai
{
    public class OnLoadCommand : AsyncCommandBase
    {
        ...
        public OnLoadCommand(CalonPegawaiViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.GetAsync($"/api/{_restApi.GetApiVersion()}/master-gaji-pegawai-capeg", param));
            _viewModel.CalonPegawaiList = new ObservableCollection<MasterPegawaiGajiCapegDto>();
            if (!Response.IsError)
            {
                var Result = Response.Data;
                if (Result.Status && Result.Data != null)
                {
                    _viewModel.CalonPegawaiList = Result.Data.ToObject<ObservableCollection<MasterPegawaiGajiCapegDto>>();
                }
                else
            ...
            _viewModel.IsEmpty = !_viewModel.CalonPegawaiList.Any();
