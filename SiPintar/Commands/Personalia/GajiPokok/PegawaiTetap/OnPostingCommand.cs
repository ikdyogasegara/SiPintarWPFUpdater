...
namespace SiPintar.Commands.Personalia.GajiPokok.PegawaiTetap
{
    public class OnPostingCommand : AsyncCommandBase
    {
        ...
        public OnPostingCommand(PegawaiTetapViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.PostAsync($"/api/{_restApi.GetApiVersion()}/master-gaji-pegawai-tetap-posting", body));
