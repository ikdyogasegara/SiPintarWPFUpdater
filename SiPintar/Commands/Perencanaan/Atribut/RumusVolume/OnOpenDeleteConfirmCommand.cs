...
namespace SiPintar.Commands.Perencanaan.Atribut.RumusVolume
{
    ...
    public class OnOpenDeleteConfirmCommand : AsyncCommandBase
    {
        ...
        public OnOpenDeleteConfirmCommand(RumusVolumeViewModel viewModel, bool isTest = false)
        {
        ...
        private void ShowDialog()
        {
            if (!_isTest)
                _ = DialogHost.Show(new DialogGlobalYesCancelView(
                    $"Hapus Data Rumus Volume?",
                    $"Data rumus volume yang akan dihapus tidak dapat dibatalkan.",
                    "warning",
