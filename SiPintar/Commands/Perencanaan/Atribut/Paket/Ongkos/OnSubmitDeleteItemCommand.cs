...
{
    public class OnSubmitDeleteItemCommand : AsyncCommandBase
    {
        ...
        public OnSubmitDeleteItemCommand(PaketOngkosViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.PatchAsync($"/api/{ApiVersion}/master-paket-ongkos", null, param));
            if (!Response.IsError)
            {
