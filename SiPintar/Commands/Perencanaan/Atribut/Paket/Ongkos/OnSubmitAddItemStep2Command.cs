...
{
    public class OnSubmitAddItemStep2Command : AsyncCommandBase
    {
        ...
        public OnSubmitAddItemStep2Command(PaketOngkosViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            {
                if (item.IdOngkos != _viewModel.SelectedItem.IdOngkos)
                    DataToSend.Add(item);
            }

            DataToSend.Add(new MasterPaketOngkosDetailDto()
            {
                IdOngkos = _viewModel.SelectedItem.IdOngkos,
