...
namespace SiPintar.Commands.Perencanaan.Atribut.Paket.Material
{
    public class OnOpenEditPaketFormCommand : AsyncCommandBase
    {
        ...
        public OnOpenEditPaketFormCommand(PaketMaterialViewModel viewModel, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            _viewModel.KodePaketForm = _viewModel.SelectedPaket.KodePaketMaterial;
            _viewModel.NamaPaketForm = _viewModel.SelectedPaket.NamaPaketMaterial;
