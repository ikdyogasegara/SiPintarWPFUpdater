...
namespace SiPintar.Commands.Bacameter.Produktivitas.PembacaanPerTanggal
{
    [ExcludeFromCodeCoverage]
    public class OnLoadCommand : AsyncCommandBase
    {
        private readonly PembacaanPerTanggalViewModel _viewModel;
        private readonly IRestApiClientModel _restApi;
        private readonly bool _isTest;

        private readonly string ApiVersion = Application.Current.Resources["api_version"]?.ToString();

        public OnLoadCommand(PembacaanPerTanggalViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            _viewModel.ChartVisibility = Visibility.Collapsed;
        ...
        private async Task GetDataListAsync()
        {
            ...
            var param = new Dictionary<string, dynamic>
            {
                ...
                { "Kategori", "pembacaan per tanggal" },
            };
            ...
            _viewModel.PembacaanPerTgl = new ObservableCollection<SummaryProduktifitasBacameterPembacaanPerTanggalDto>();
            ...
            if (!Response.IsError)
            {
                ...
                if (Result.Status && Result.Data != null)
                    _viewModel.PembacaanPerTgl = Result.Data.ToObject<ObservableCollection<SummaryProduktifitasBacameterPembacaanPerTanggalDto>>();
                else
