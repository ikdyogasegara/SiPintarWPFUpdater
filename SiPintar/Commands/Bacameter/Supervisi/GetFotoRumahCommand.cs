...
namespace SiPintar.Commands.Bacameter.Supervisi
{
    public class GetFotoRumahCommand : AsyncCommandBase
    {
        ...
        private int section = 1; // 1: Thumbnail Foto Rumah, 2: Thumbnail Foto Rumah Baca Ulang, 3: File Master Foto Rumah

        private readonly string FolderPath = Path.Combine(Path.GetTempPath(), "PDAM-SiPintar-Net");

        public GetFotoRumahCommand(SupervisiViewModel viewModel, bool isTest = false)
        {
