...
namespace SiPintar.Commands.Bacameter.Supervisi
{
    public class OnSubmitLampiranCommand : AsyncCommandBase
    {
        ...
        public OnSubmitLampiranCommand(SupervisiViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        {
            if (_viewModel.SelectedData == null || _viewModel.KoreksiForm == null)
                return;
