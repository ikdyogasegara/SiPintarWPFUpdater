...
{
    public class OnSubmitBatalkanHasilBacaUlangCommand : AsyncCommandBase
    {
        ...
        public OnSubmitBatalkanHasilBacaUlangCommand(SupervisiViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var Response = await Task.Run(() => _restApi.PatchAsync($"/api/{ApiVersion}/rekening-air-unrequest-baca-ulang", null, body));
            if (!Response.IsError)
            {
