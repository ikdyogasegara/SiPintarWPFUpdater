...
{
    public class OnSubmitSetBelumDibacaCommand : AsyncCommandBase
    {
        ...
        public OnSubmitSetBelumDibacaCommand(SupervisiViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
