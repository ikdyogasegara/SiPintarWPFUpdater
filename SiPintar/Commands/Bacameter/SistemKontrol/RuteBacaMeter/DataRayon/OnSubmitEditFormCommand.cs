...
namespace SiPintar.Commands.Bacameter.SistemKontrol.RuteBacaMeter.DataRayon
{
    public class OnSubmitEditFormCommand : AsyncCommandBase
    {
        ...
        public OnSubmitEditFormCommand(DataRayonViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        {
            if (_viewModel.SelectedRayon == null || _viewModel.SelectedJadwal == null)
                return;
