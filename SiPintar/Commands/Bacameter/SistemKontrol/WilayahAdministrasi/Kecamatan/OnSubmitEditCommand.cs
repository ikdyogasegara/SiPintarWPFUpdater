...
namespace SiPintar.Commands.Bacameter.SistemKontrol.WilayahAdministrasi.Kecamatan
{
    public class OnSubmitEditCommand : AsyncCommandBase
    {
        ...
        public OnSubmitEditCommand(KecamatanViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            else if (_viewModel.Section == "kelurahan")
            {
                ...
                body.Add("IdKecamatan", _viewModel.SelectedKecamatan.IdKecamatan);
                body.Add("IdKelurahan", _viewModel.SelectedKelurahan.IdKelurahan);
            ...
            var Response = await Task.Run(() => _restApi.PatchAsync(url, null, body));
            if (!Response.IsError)
            {
