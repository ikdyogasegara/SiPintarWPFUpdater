...
namespace SiPintar.Commands.Bacameter.SistemKontrol.DistribusiPelanggan.PerGolongan
{
    [ExcludeFromCodeCoverage]
    public class OnLoadCommand : AsyncCommandBase
    {
        private readonly PerGolonganViewModel _viewModel;
        private readonly IRestApiClientModel _restApi;
        private readonly bool _isTest;

        private readonly string ApiVersion = Application.Current.Resources["api_version"]?.ToString();

        public OnLoadCommand(PerGolonganViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        private async Task GetDataListAsync()
        {
            ...
            _viewModel.GolonganList = new ObservableCollection<SummaryDistribusiPelangganDto>();
            ...
            if (!Response.IsError)
            {
                ...
                if (Result.Status && Result.Data != null)
                    _viewModel.GolonganList = Result.Data.ToObject<ObservableCollection<SummaryDistribusiPelangganDto>>();
                else
            ...
            _viewModel.IsEmpty = _viewModel.GolonganList.Count == 0;
