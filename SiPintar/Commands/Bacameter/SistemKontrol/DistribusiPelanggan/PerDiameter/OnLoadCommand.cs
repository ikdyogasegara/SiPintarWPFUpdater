...
namespace SiPintar.Commands.Bacameter.SistemKontrol.DistribusiPelanggan.PerDiameter
{
    [ExcludeFromCodeCoverage]
    public class OnLoadCommand : AsyncCommandBase
    {
        private readonly PerDiameterViewModel _viewModel;
        private readonly IRestApiClientModel _restApi;
        private readonly bool _isTest;

        private readonly string ApiVersion = Application.Current.Resources["api_version"]?.ToString();

        public OnLoadCommand(PerDiameterViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        private async Task GetDataListAsync()
        {
            ...
            _viewModel.DiameterList = new ObservableCollection<SummaryDistribusiPelangganDto>();
            ...
            if (!Response.IsError)
            {
                ...
                if (Result.Status && Result.Data != null)
                    _viewModel.DiameterList = Result.Data.ToObject<ObservableCollection<SummaryDistribusiPelangganDto>>();
                else
            ...
            _viewModel.IsEmpty = _viewModel.DiameterList.Count == 0;
