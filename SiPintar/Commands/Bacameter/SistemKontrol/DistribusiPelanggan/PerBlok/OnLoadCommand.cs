...
namespace SiPintar.Commands.Bacameter.SistemKontrol.DistribusiPelanggan.PerBlok
{
    [ExcludeFromCodeCoverage]
    public class OnLoadCommand : AsyncCommandBase
    {
        private readonly PerBlokViewModel _viewModel;
        private readonly IRestApiClientModel _restApi;
        private readonly bool _isTest;

        private readonly string ApiVersion = Application.Current.Resources["api_version"]?.ToString();

        public OnLoadCommand(PerBlokViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        private async Task GetDataListAsync()
        {
            ...
            _viewModel.BlokList = new ObservableCollection<SummaryDistribusiPelangganDto>();
            ...
            if (!Response.IsError)
            {
                ...
                if (Result.Status && Result.Data != null)
                    _viewModel.BlokList = Result.Data.ToObject<ObservableCollection<SummaryDistribusiPelangganDto>>();
                else
            ...
            _viewModel.IsEmpty = _viewModel.BlokList.Count == 0;
