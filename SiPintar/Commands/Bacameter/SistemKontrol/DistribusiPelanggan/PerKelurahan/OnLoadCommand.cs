...
namespace SiPintar.Commands.Bacameter.SistemKontrol.DistribusiPelanggan.PerKelurahan
{
    [ExcludeFromCodeCoverage]
    public class OnLoadCommand : AsyncCommandBase
    {
        private readonly PerKelurahanViewModel _viewModel;
        private readonly IRestApiClientModel _restApi;
        private readonly bool _isTest;

        private readonly string ApiVersion = Application.Current.Resources["api_version"]?.ToString();

        public OnLoadCommand(PerKelurahanViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        private async Task GetDataListAsync()
        {
            ...
            var param = new Dictionary<string, dynamic>
            {
                ...
                { "Kategori", "per kelurahan" },
                { "IdKecamatan", _viewModel.Parent.SelectedKecamatan?.IdKecamatan },
            };
            ...
            _viewModel.KelurahanList = new ObservableCollection<SummaryDistribusiPelangganDto>();
            ...
            if (!Response.IsError)
            {
                ...
                if (Result.Status && Result.Data != null)
                    _viewModel.KelurahanList = Result.Data.ToObject<ObservableCollection<SummaryDistribusiPelangganDto>>();
                else
            ...
            _viewModel.IsEmpty = _viewModel.KelurahanList.Count == 0;
