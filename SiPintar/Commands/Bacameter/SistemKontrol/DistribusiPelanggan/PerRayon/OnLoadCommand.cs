...
namespace SiPintar.Commands.Bacameter.SistemKontrol.DistribusiPelanggan.PerRayon
{
    ...
    public class OnLoadCommand : AsyncCommandBase
    {
        ...
        public OnLoadCommand(PerRayonViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        private async Task GetDataListAsync()
        {
            ...
            _viewModel.RayonList = new ObservableCollection<SummaryDistribusiPelangganDto>();
            ...
            if (!Response.IsError)
            {
                ...
                if (Result.Status && Result.Data != null)
                    _viewModel.RayonList = Result.Data.ToObject<ObservableCollection<SummaryDistribusiPelangganDto>>();
                else
            ...
            _viewModel.IsEmpty = _viewModel.RayonList.Count == 0;
