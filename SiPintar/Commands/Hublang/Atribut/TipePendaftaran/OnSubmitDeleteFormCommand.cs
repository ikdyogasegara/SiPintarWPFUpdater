...
namespace SiPintar.Commands.Hublang.Atribut.TipePendaftaran
{
    public class OnSubmitDeleteFormCommand : AsyncCommandBase
    {
        ...
        public OnSubmitDeleteFormCommand(TipePendaftaranViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            {
                { "IdTipePendaftaranSambungan", _viewModel.SelectedData.IdTipePendaftaranSambungan }
            };
            RestApiResponse Response = await Task.Run(() => _restApi.DeleteAsync($"/api/{_restApi.GetApiVersion()}/master-tipe-pendaftaran-sambungan", body));
