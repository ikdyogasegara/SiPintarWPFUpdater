...
namespace SiPintar.Commands.Hublang.Atribut.JenisBangunan
{
    public class OnSubmitDeleteFormCommand : AsyncCommandBase
    {
        ...
        public OnSubmitDeleteFormCommand(JenisBangunanViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            {
                { "IdJenisBangunan", _viewModel.SelectedData.IdJenisBangunan }
            };
            RestApiResponse Response = await Task.Run(() => _restApi.DeleteAsync($"/api/{_restApi.GetApiVersion()}/master-jenis-bangunan", body));
