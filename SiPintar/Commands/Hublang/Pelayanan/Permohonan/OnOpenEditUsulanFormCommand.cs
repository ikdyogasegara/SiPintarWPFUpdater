...
{
    public class OnOpenEditUsulanFormCommand : AsyncCommandBase
    {
        private readonly PermohonanViewModel _viewModel;
        private readonly IRestApiClientModel _restApi;
        private readonly bool _isTest;

        public OnOpenEditUsulanFormCommand(PermohonanViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (!_isTest && !anyError)
                    {
                        await DialogHost.Show(new DialogUsulanFormView(_viewModel), "DistribusiRootDialog");
                    }
                }
            }
