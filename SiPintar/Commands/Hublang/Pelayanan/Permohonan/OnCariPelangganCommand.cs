...
namespace SiPintar.Commands.Hublang.Pelayanan.Permohonan
{
    ...
    public class OnCariPelangganCommand : AsyncCommandBase
    {
        ...
        public OnCariPelangganCommand(PermohonanViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            var response = await Task.Run(() => _restApi.GetAsync($"/api/{_restApi.GetApiVersion()}/{_viewModel.EndPointPelanggan}", param));
