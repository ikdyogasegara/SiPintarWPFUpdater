...
namespace SiPintar.Commands.Hublang.Pelayanan.Permohonan
{
    public class OnOpenAddFormCommand : AsyncCommandBase
    {
        ...
        public OnOpenAddFormCommand(PermohonanViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        [ExcludeFromCodeCoverage]
        private object GetInstance() => new DialogFormView(_viewModel, _restApi);
    }
}
