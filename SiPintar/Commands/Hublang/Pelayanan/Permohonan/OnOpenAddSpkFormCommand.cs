...
{
    public class OnOpenAddSpkFormCommand : AsyncCommandBase
    {
        private readonly PermohonanViewModel _viewModel;
        private readonly IRestApiClientModel _restApi;
        private readonly bool _isTest;

        public OnOpenAddSpkFormCommand(PermohonanViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            _viewModel.SelectedPegawai.Clear();
        ...
        [ExcludeFromCodeCoverage]
        private object GetInstance() => new DialogSpkFormView(_viewModel, _restApi);
    }
}
