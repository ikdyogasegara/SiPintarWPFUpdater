...
{
    public class OnOpenLihatFotoSPKCommand : AsyncCommandBase
    {
        ...
        public OnOpenLihatFotoSPKCommand(HistoriPermohonanViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            if (_viewModel.SelectedData.FotoBuktiSPK1 == null && _viewModel.SelectedData.FotoBuktiSPK2 == null && _viewModel.SelectedData.FotoBuktiSPK3 == null)
            {
                ShowAlert();
                return;
            }
            ...
            {
                case "AIR":
                    _EndPoint = "permohonan-pelanggan-air-spk-link-foto";
                    break;
                case "LIMBAH":
                    _EndPoint = "permohonan-pelanggan-limbah-spk-link-foto";
                    break;
                case "L2T2":
                    _EndPoint = "permohonan-pelanggan-lltt-spk-link-foto";
                    break;
                case "NON-PEL":
                    _EndPoint = "permohonan-non-pelanggan-spk-link-foto";
                    break;
            }
            ...
            if (!Response.IsError)
            {
                ...
                {
                    var result = Result.Data.ToObject<ObservableCollection<PermohonanPelangganAirSpkDto>>();
                    _viewModel.Tipe = "Foto Bukti SPK";
                    ...
                    _viewModel.LabelNomor = "Nomor SPK";
                    _viewModel.Nomor = _viewModel.SelectedData.NomorSpk ?? "-";
        ...
        private List<BitmapImage> GetFoto(ObservableCollection<PermohonanPelangganAirSpkDto> result)
        {
