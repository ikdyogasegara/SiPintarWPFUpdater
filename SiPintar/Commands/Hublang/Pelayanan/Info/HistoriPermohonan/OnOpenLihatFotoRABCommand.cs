...
{
    public class OnOpenLihatFotoRABCommand : AsyncCommandBase
    {
        ...
        public OnOpenLihatFotoRABCommand(HistoriPermohonanViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            if (_viewModel.SelectedData.FotoBuktiRAB1 == null && _viewModel.SelectedData.FotoBuktiRAB2 == null && _viewModel.SelectedData.FotoBuktiRAB3 == null)
            {
                ShowAlert();
                return;
            }
            ...
            if (!Response.IsError)
            {
                ...
                if (Result.Status && Result.Data != null)
                {
                    ...
                    _viewModel.Tipe = "Foto Bukti RAB";
