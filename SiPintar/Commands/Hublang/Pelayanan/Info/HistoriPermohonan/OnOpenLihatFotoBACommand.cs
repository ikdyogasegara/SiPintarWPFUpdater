...
{
    public class OnOpenLihatFotoBACommand : AsyncCommandBase
    {
        ...
        public OnOpenLihatFotoBACommand(HistoriPermohonanViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            if (_viewModel.SelectedData.FotoBuktiBA1 == null && _viewModel.SelectedData.FotoBuktiBA2 == null && _viewModel.SelectedData.FotoBuktiBA3 == null)
            {
                ShowAlert();
                return;
            }
            ...
            {
                case "AIR":
                    _EndPoint = "permohonan-pelanggan-air-berita-acara-link-foto";
                    break;
                case "LIMBAH":
                    _EndPoint = "permohonan-pelanggan-limbah-berita-acara-link-foto";
                    break;
                case "L2T2":
                    _EndPoint = "permohonan-pelanggan-lltt-berita-acara-link-foto";
                    break;
                case "NON-PEL":
                    _EndPoint = "permohonan-non-pelanggan-berita-acara-link-foto";
                    break;
            }
            ...
            if (!Response.IsError)
            {
                ...
                {
                    var result = Result.Data.ToObject<ObservableCollection<PermohonanPelangganAirBaDto>>();
                    _viewModel.Tipe = "Foto Bukti Berita Acara";
                    ...
                    _viewModel.LabelNomor = "Nomor Berita Acara";
                    _viewModel.Nomor = _viewModel.SelectedData.NomorBa ?? "-";
        ...
        private List<BitmapImage> GetFoto(ObservableCollection<PermohonanPelangganAirBaDto> result)
        {
