...
{
    public class OnSubmitEditUserCommand : AsyncCommandBase
    {
        private readonly DaftarPenggunaViewModel _viewModel;
        private readonly IRestApiClientModel _restApi;
        private readonly bool _isTest;

        public OnSubmitEditUserCommand(DaftarPenggunaViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
