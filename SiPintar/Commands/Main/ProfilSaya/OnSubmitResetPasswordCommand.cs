...
namespace SiPintar.Commands.Main.ProfilSaya
{
    public class OnSubmitResetPasswordCommand : AsyncCommandBase
    {
        ...
        public OnSubmitResetPasswordCommand(ProfilSayaViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            if (App.OpenedWindow.ContainsKey("main"))
                DialogHelper.ShowSuccessErrorDialog(ErrorMessage, SuccessMessage, _isTest, "MainRootDialog",
                    App.OpenedWindow["main"], true, _viewModel.OnLoadCommand, true);
