...
namespace SiPintar.Commands.Distribusi.Atribut.KelainanGantiMeter.GantiMeterRutin
{
    public class OnLoadCommand : AsyncCommandBase
    {
        ...
        public OnLoadCommand(GantiMeterRutinViewModel viewModel, IRestApiClientModel restApi, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            Param.Add("Kategori", "Ganti Meter Rutin");
            ...
            if (!Response.IsError)
            {
                ...
                if (Result.Status && Result.Data != null)
                {
                    ...
                    if (_viewModel.JenisGantiMeterList != null)
                    {
