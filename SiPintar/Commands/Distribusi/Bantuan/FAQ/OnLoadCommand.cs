...
using static SiPintar.ViewModels.Distribusi.Bantuan.FaqViewModel;

namespace SiPintar.Commands.Distribusi.Bantuan.FAQ
{
    [ExcludeFromCodeCoverage]
    public class OnLoadCommand : AsyncCommandBase
    {
        private readonly FaqViewModel _viewModel;
        private readonly string DirectoryToScan = $"{Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location)}\\FAQ\\Distribusi";
