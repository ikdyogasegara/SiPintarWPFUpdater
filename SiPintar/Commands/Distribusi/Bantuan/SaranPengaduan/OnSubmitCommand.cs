...
namespace SiPintar.Commands.Distribusi.Bantuan.SaranPengaduan
{
    public class OnSubmitCommand : AsyncCommandBase
    {
        ...
        {
            _ = DialogHost.Show(new DialogGlobalView("Terjadi Kesalahan", ErrorMessage, "error"), "DistribusiRootDialog");
        }
