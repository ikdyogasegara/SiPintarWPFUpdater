...
namespace SiPintar.Commands.Distribusi.Distribusi.GantiMeterNonRutin
{
    public class OnFilterCommand : AsyncCommandBase
    {
        ...
        public OnFilterCommand(GantiMeterNonRutinViewModel viewModel, bool isTest = false)
        {
        ...
        public override async Task ExecuteAsync(object parameter)
        {
            ...
            else if (_viewModel.PageViewModel is RotasiMeterNonRutinViewModel rotasiMeter)
