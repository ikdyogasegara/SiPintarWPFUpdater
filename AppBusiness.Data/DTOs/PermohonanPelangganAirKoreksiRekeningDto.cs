...
{
    public class PermohonanPelangganAirKoreksiRekeningDto
    {
        ...
        public bool? FlagLunas { get; set; } = false;
    ...
    public class PermohonanPelangganAirKoreksiRekeningFilterDto : PermohonanPelangganAirKoreksiRekeningDto
    {
        public string StatusPermohonanText { get; set; }
        public DateTime? WaktuStatusVerifikasiLapanganMulai { get; set; }
        public DateTime? WaktuStatusVerifikasiLapanganSampaiDengan { get; set; }
        public DateTime? WaktuStatusVerifikasiPusatMulai { get; set; }
        public DateTime? WaktuStatusVerifikasiPusatSampaiDengan { get; set; }
        public DateTime? TanggalMulaiPermohonan { get; set; }
        public DateTime? TanggalSampaiDenganPermohonan { get; set; }
        public DateTime? TanggalMulaiUsulan { get; set; }
        public DateTime? TanggalSampaiDenganUsulan { get; set; }
    }
}
