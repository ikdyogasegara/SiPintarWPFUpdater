...
{
    public class ParamPermohonanPelangganAirRabDto
    {
        ...
        public List<ParamPermohonanPelangganAirRabDetailDto> Detail { get; set; }
    ...
    public class ParamPermohonanPelangganAirRabDetailDto
    {
    ...
    public class ParamPermohonanPelangganAirBPPIDto
    {
        public int? IdPdam { get; set; }
        public int? IdPermohonan { get; set; }
    ...
    public class ParamPermohonanPelangganAirSPKPdanSPPBDto
    {
        public int? IdPdam { get; set; }
        public int? IdPermohonan { get; set; }
        ...
        public int? IdUserRequest { get; set; }
        public List<ParamPetugasSPKPAirDto> Petugas { get; set; }
    }

    public class ParamPetugasSPKPAirDto
    {
