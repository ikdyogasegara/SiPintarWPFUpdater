...
{
    public class PermohonanPelangganLlttBaDto
    {
        ...
        public List<PermohonanPelangganLlttRkpDetailDto> DetailPersil { get; set; }
        ...
        public List<PermohonanPelangganLlttRkpDetailDto> DetailDistribusi { get; set; }
