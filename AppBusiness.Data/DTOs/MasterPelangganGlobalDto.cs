...
{
    public class MasterPelangganGlobalDto
    {
        ...
        public string Keterangan { get; set; } // untuk limbah n lltt
        public string NoHp { get; set; } // untuk limbah n lltt
        public string NoTelp { get; set; } // untuk limbah n lltt
        public string NoKtp { get; set; } // untuk limbah n lltt
        public string Email { get; set; } // untuk limbah n lltt
