...
{
    public class ParamPermohonanPelangganLlttDto
    {
        ...
        public List<ParamPermohonanPelangganLlttDetailDto> DetailParameter { get; set; }
        public int? IdJenisNonAir { get; set; }
        public List<ParamPermohonanPelangganLlttBiayaDto> DetailBiaya { get; set; }
    }

    public class ParamPermohonanPelangganLlttDetailDto
    {
    ...
    public class ParamPermohonanPelangganLlttBiayaDto
    {
        public string Parameter { get; set; }
    ...
    public class ParamPermohonanPelangganLlttFilterDto
    {
        ...
        public List<PermohonanPelangganLlttDetailDto> DetailParameter { get; set; }
        ...
        public List<PermohonanPelangganLlttPetugasDto> Petugas { get; set; }
        public List<PermohonanPelangganLlttRabDto> RAB { get; set; }
