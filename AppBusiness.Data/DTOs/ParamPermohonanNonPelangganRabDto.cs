...
{
    public class ParamPermohonanNonPelangganRabDto
    {
        ...
        public List<ParamPermohonanNonPelangganRabDetailDto> Detail { get; set; }
    ...
    public class ParamPermohonanNonPelangganRabDetailDto
    {
    ...
    public class ParamPermohonanNonPelangganBPPIDto
    {
        public int? IdPdam { get; set; }
        public int? IdPermohonan { get; set; }
    ...
    public class ParamPermohonanNonPelangganSPKPdanSPPBDto
    {
        public int? IdPdam { get; set; }
        public int? IdPermohonan { get; set; }
        ...
        public int? IdUserRequest { get; set; }
        public List<ParamPetugasSPKPNonPelangganDto> Petugas { get; set; }
    }

    public class ParamPetugasSPKPNonPelangganDto
    {
