...
{
    public class ParamPermohonanPelangganLlttRabDto
    {
        ...
        public List<ParamPermohonanPelangganLlttRabDetailDto> Detail { get; set; }
    ...
    public class ParamPermohonanPelangganLlttRabDetailDto
    {
    ...
    public class ParamPermohonanPelangganLlttBPPIDto
    {
        public int? IdPdam { get; set; }
        public int? IdPermohonan { get; set; }
    ...
    public class ParamPermohonanPelangganLlttSPKPdanSPPBDto
    {
        public int? IdPdam { get; set; }
        public int? IdPermohonan { get; set; }
        ...
        public int? IdUserRequest { get; set; }
        public List<ParamPetugasSPKPLlttDto> Petugas { get; set; }
    }

    public class ParamPetugasSPKPLlttDto
    {
