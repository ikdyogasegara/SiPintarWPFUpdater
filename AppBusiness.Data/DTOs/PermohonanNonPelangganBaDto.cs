...
{
    public class PermohonanNonPelangganBaDto
    {
        ...
        public List<PermohonanNonPelangganRkpDetailDto> DetailPersil { get; set; }
        ...
        public List<PermohonanNonPelangganRkpDetailDto> DetailDistribusi { get; set; }
