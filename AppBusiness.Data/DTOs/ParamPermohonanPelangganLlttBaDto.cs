...
{
    public class ParamPermohonanPelangganLlttBaDto
    {
        ...
        public List<ParamPermohonanPelangganLlttRkpDetailDto> DetailRkp { get; set; }
        public List<ParamPetugasBaLlttDto> Petugas { get; set; }
    }

    public class ParamPetugasBaLlttDto
    {
        public int? IdPegawai { get; set; }
    }

    public class ParamPermohonanPelangganLlttRkpDetailDto
    {
