...
{
    public class ParamPermohonanPelangganLimbahBaDto
    {
        ...
        public List<ParamPermohonanPelangganLimbahRkpDetailDto> DetailRkp { get; set; }
        public List<ParamPetugasBaLimbahDto> Petugas { get; set; }
    }

    public class ParamPetugasBaLimbahDto
    {
        public int? IdPegawai { get; set; }
    }

    public class ParamPermohonanPelangganLimbahRkpDetailDto
    {
