...
{
    public class PermohonanPelangganAirBaCetakDto
    {
        ...
        public DateTime WaktuAntarMulai { get; set; } = DateTime.Now;
        public DateTime WaktuAntarSelesai { get; set; } = DateTime.Now;
