...
{
    public class PermohonanPelangganAirRabDto
    {
        ...
        public List<PermohonanPelangganAirRabDetailDto> DetailPersil { get; set; }
        ...
        public List<PermohonanPelangganAirRabDetailDto> DetailDistribusi { get; set; }
