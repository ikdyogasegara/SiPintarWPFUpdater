...
{
    public class ParamPermohonanPelangganAirBaDto
    {
        ...
        public List<ParamPermohonanPelangganAirRkpDetailDto> DetailRkp { get; set; }
        public List<ParamPetugasBaAirDto> Petugas { get; set; }
    }

    public class ParamPetugasBaAirDto
    {
        public int? IdPegawai { get; set; }
    }

    public class ParamPermohonanPelangganAirRkpDetailDto
    {
