...
{
    public class ParamMasterSetPotonganBulananDto
    {
        ...
        public bool? FlagAngsuran { get; set; } = false;
    ...
    public class ParamMasterSetPotonganBulananFilterDto : ParamMasterSetPotonganBulananDto
    {
        public string NoPegawai { get; set; }
        public string NamaPegawai { get; set; }
    }

    public class ParamMasterSetPotonganBulananSalinDataDto
    {
        public int? IdPdam { get; set; }
        public int? KodePeriodeAsal { get; set; }
        public int? IdKodeGajiAsal { get; set; }
        public int? IdJenisPotonganAsal { get; set; }
