...
{
    public class ParamMutasiStatusTetapDto
    {
        ...
        public List<ParamMutasiStatusTetapDetailDto> Detail { get; set; }
        public int? IdUserRequest { get; set; }
    }

    public class ParamMutasiStatusTetapDetailDto
    {
    ...
    public class ParamMutasiStatusTetapFilterDto : ParamMutasiStatusTetapDto
    {
        public int? IdPegawai { get; set; }
        public string NoPegawai { get; set; }
    ...
    public class ParamVerifikasiMutasiStatusTetapDto
    {
        public int? IdPdam { get; set; }
        public int? IdMutasi { get; set; }
        public int? IdUserRequest { get; set; }
